...
public enum GolemType {
    ...
    LEAPLEAF(ModBlocks.OVERGROWN_ROOTS::defaultBlockState, new LeapleafMold()),
    ICE_GOLEM(Blocks.BLUE_ICE::defaultBlockState, new IceGolemMold()),
    SQUALL_GOLEM(ModBlocks.JADE_BLOCK::defaultBlockState, new SquallGolemMold()),
    REDSTONE_GOLEM(Blocks.REDSTONE_BLOCK::defaultBlockState, new RedstoneGolemMold()),
    GRAVE_GOLEM(ModBlocks.SKULL_PILE::defaultBlockState, new GraveGolemMold()),
    REDSTONE_MONSTROSITY(ModBlocks.REINFORCED_REDSTONE_BLOCK::defaultBlockState, new RedstoneMonstrosityMold());
