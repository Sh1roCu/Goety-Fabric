...
public class FollowFireParticle extends TextureSheetParticle {
    ...
    public static class Provider implements ParticleProvider<Option> {
        ...
        @Override
        public Particle createParticle(Option p_106838_, ClientLevel p_106839_, double p_106840_, double p_106841_, double p_106842_, double p_106843_, double p_106844_, double p_106845_) {
    ...
    public static class Option implements ParticleOptions {
        ...
        public ParticleType<Option> getType() {
            return ModParticleTypes.FOLLOW_CULT_SPELL;
        }
