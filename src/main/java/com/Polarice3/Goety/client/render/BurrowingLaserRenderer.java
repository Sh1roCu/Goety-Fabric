...
public class BurrowingLaserRenderer {
    ...
    public static void renderLaser(WorldRenderContext context, Player player, float ticks) {
        ...
        drawLasers(context, playerPos, trace, 0, 0, 0, 0.02F, player, ticks, speedModifier);
    }
    ...
    private static void drawLasers(WorldRenderContext context, Vec3 from, HitResult trace, double xOffset, double yOffset, double zOffset, float thickness, Player player, float ticks, float speedModifier) {
