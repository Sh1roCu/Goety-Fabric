...
public class SiennaGrassBlock extends SiennaPlantBlock implements BonemealableBlock {
    ...
    public void performBonemeal(ServerLevel p_222578_, RandomSource p_222579_, BlockPos p_222580_, BlockState p_222581_) {
        ...
        if (p_222581_.is(ModBlocks.SIENNA_FERN)) {
            doubleplantblock = (DoublePlantBlock) ModBlocks.LARGE_SIENNA_FERN;
        } else if (p_222581_.is(ModBlocks.SIENNA_GRASS)) {
            doubleplantblock = (DoublePlantBlock) ModBlocks.TALL_SIENNA_GRASS;
        }
