...
public class CursedInfuserBlockEntity extends ModBlockEntity implements Clearable, WorldlyContainer {
    ...
    public CursedInfuserBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.CURSED_INFUSER, blockPos, blockState);
    }
                ...
                if (!itemstack.isEmpty()) {
                    ...
                    if (this.level != null) {
                        ItemStack itemstack1 = this.level.getRecipeManager()
                                .getRecipeFor(ModRecipeSerializer.CURSED_INFUSER, iinventory, this.level)
    ...
    public Optional<CursedInfuserRecipes> getRecipes(ItemStack pStack) {
        return this.items.stream().noneMatch(ItemStack::isEmpty) ? Optional.empty() : this.level.getRecipeManager().getRecipeFor(ModRecipeSerializer.CURSED_INFUSER, new SimpleContainer(pStack), this.level);
    }
