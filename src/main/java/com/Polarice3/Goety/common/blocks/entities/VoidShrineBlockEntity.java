...
public class VoidShrineBlockEntity extends PedestalBlockEntity {
    ...
    public VoidShrineBlockEntity(BlockPos p_155229_, BlockState p_155230_) {
        super(ModBlockEntities.VOID_SHRINE, p_155229_, p_155230_);
    }
                ...
                if (!this.getBlockState().getValue(VoidShrineBlock.TRIGGERED)) {
                    ...
                    if (this.tick < 100) {
                        ...
                        if (this.level.getRandom().nextInt(20) == 0) {
                            ...
                            ModNetwork.sendToALL(serverLevel.getServer(), SLightningPacket.ID, SLightningPacket.encode(vec3, endVec, new ColorUtil(ChatFormatting.LIGHT_PURPLE), 2));
                        }
                        if (this.tick % 5 == 0) {
                    ...
                    if (this.tick == 100) {
                        ...
                        EnderKeeper keeper = new EnderKeeper(ModEntityType.ENDER_KEEPER, serverLevel);
                        keeper.setPos(vec3);
                    ...
                    var storage = this.getItemStorage(null);
                    if (storage != null) {
                        itemStack = storage.getStackInSlot(0);
                    }
