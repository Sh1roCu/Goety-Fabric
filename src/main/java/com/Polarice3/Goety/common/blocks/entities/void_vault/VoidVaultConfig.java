...
public record VoidVaultConfig(ResourceLocation lootTable, double activationRange, double deactivationRange,
    ...
    public VoidVaultConfig() {
        this(ModLootTables.VOID_VAULT_REWARD, 4.0, 4.5, new ItemStack(ModItems.VOID_KEY), Optional.empty(), PlayerDetector.INCLUDING_CREATIVE_PLAYERS, PlayerDetector.EntitySelector.SELECT_FROM_LEVEL);
    }
