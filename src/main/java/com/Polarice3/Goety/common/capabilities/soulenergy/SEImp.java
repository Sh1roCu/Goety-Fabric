...
public class SEImp implements ISoulEnergy {
    ...
    private final Set<UUID> grudgeList = new HashSet<>();
    private final List<EntityType<?>> grudgeTypeList = new ArrayList<>();
    private final Set<UUID> allyList = new HashSet<>();
    private final List<EntityType<?>> allyTypeList = new ArrayList<>();
    private final Set<UUID> groundedList = new HashSet<>();
    private final List<EntityType<?>> groundedTypeList = new ArrayList<>();
    private final List<Research> researchList = new ArrayList<>();
    ...
    public void readFromNbt(@NotNull CompoundTag compoundTag) {
        SEHelper.load(compoundTag, this);
    }

    @Override
    public void writeToNbt(@NotNull CompoundTag compoundTag) {
        SEHelper.save(compoundTag, this);
    }
}
