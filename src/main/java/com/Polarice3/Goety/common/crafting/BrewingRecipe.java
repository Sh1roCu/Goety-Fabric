...
public class BrewingRecipe implements Recipe<Container> {
    ...
    public RecipeType<?> getType() {
        return ModRecipeSerializer.BREWING_TYPE;
    }
    ...
    public static class Serializer implements RecipeSerializer<BrewingRecipe> {
        ...
        public BrewingRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            if (json.has("entity")) {
                ...
                if (data2 != null) {
                    if (data2.has("entity_type")) {
                        ...
                        entityTag = TagKey.create(Registries.ENTITY_TYPE, resourceLocation);
                    }
                }
            }
            return new BrewingRecipe(id,
                    ...
                    entityTag,
                    entityType,
                    BuiltInRegistries.MOB_EFFECT.get(new ResourceLocation(GsonHelper.getAsString(json, "effect"))),
        ...
        public BrewingRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            MobEffect mobEffect = BuiltInRegistries.MOB_EFFECT.get(new ResourceLocation(buf.readUtf()));
        ...
        public void toNetwork(FriendlyByteBuf buf, BrewingRecipe recipe) {
            ...
            ResourceLocation effect = BuiltInRegistries.MOB_EFFECT.getKey(recipe.output);
            buf.writeUtf(effect != null ? effect.toString() : "");
