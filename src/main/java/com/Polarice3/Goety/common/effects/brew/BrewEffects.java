...
public class BrewEffects {
    ...
    public BrewEffects() {
        ...
        this.modifierRegister(new CapacityModifier(2), ModItems.SNAP_FUNGUS);
        this.modifierRegister(new CapacityModifier(3), ModItems.MAGIC_EMERALD);
        this.modifierRegister(new CapacityModifier(4), ModItems.SOUL_EMERALD);
        this.modifierRegister(new CapacityModifier(5), ModItems.WITHERED_MANUSCRIPT);
        this.modifierRegister(new CapacityModifier(6), ModItems.SOUL_RUBY);
        ...
        this.modifierRegister(new BrewModifier(BrewModifier.AMPLIFIER, 2), ModItems.MYSTIC_CORE);
        ...
        this.modifierRegister(new BrewModifier(BrewModifier.AOE, 2), ModBlocks.TALL_SKULL_ITEM);
        ...
        this.modifierRegister(new BrewModifier(BrewModifier.GAS), ModItems.WIND_CORE);
        ...
        this.register(new PotionBrewEffect(MobEffects.CONFUSION, BrewConfig.NauseaCost.get(), 900), ModItems.REFUSE_BOTTLE);
        ...
        this.register(new PotionBrewEffect(MobEffects.DAMAGE_RESISTANCE, BrewConfig.ResistanceCost.get(), BrewConfig.ResistanceCapacity.get(), 1800), ModItems.RESILIENCE_LOTION);
        ...
        //Goety
        this.register(new PotionBrewEffect(GoetyEffects.ARROWMANTIC, BrewConfig.ArrowmanticCost.get(), 900), Items.TARGET);
        this.register(new PotionBrewEffect(GoetyEffects.BOTTLING, BrewConfig.BottlingCost.get(), BrewConfig.BottlingCapacity.get(), 3600), ModItems.WITCH_HAT);
        this.register(new PotionBrewEffect(GoetyEffects.BOTTLING, BrewConfig.BottlingCost.get(), BrewConfig.BottlingCapacity.get(), 3600), ModItems.WITCH_HAT_HEDGE);
        this.register(new PotionBrewEffect(GoetyEffects.CLIMBING, BrewConfig.ClimbingCost.get(), 3600), ModItems.SPIDER_EGG);
        this.register(new PotionBrewEffect(GoetyEffects.CORPSE_EATER, BrewConfig.CorpseEaterCost.get(), BrewConfig.CorpseEaterCapacity.get(), 3600), Items.ZOMBIE_HEAD);
        this.register(new PotionBrewEffect(GoetyEffects.CURSED, BrewConfig.CursedCost.get(), BrewConfig.CursedCapacity.get(), 600), ModItems.OCCULT_FABRIC);
        this.register(new PotionBrewEffect(GoetyEffects.DEFLECTIVE, BrewConfig.DeflectiveCost.get(), BrewConfig.DeflectiveCapacity.get(), 1800), Items.SHULKER_BOX);
        this.register(new PotionBrewEffect(GoetyEffects.ENDER_GROUND, BrewConfig.EnderGroundCost.get(), 900), Items.ENDER_PEARL);
        this.register(new PotionBrewEffect(GoetyEffects.EVIL_EYE, BrewConfig.EvilEyeCost.get(), BrewConfig.EvilEyeCapacity.get(), 3600), ModBlocks.FORBIDDEN_GRASS.asItem());
        this.register(new PotionBrewEffect(GoetyEffects.EXPLOSIVE, BrewConfig.ExplosiveCost.get(), BrewConfig.ExplosiveCapacity.get(), 900), Items.CREEPER_HEAD);
        this.register(new PotionBrewEffect(GoetyEffects.FIERY_AURA, BrewConfig.FieryAuraCost.get(), BrewConfig.FieryAuraCapacity.get(), 1800), Items.MAGMA_BLOCK);
        this.register(new PotionBrewEffect(GoetyEffects.FIRE_TRAIL, BrewConfig.FireTrailCost.get(), BrewConfig.FireTrailCapacity.get(), 900), Items.LAVA_BUCKET);
        this.register(new PotionBrewEffect(GoetyEffects.FLAME_HANDS, BrewConfig.FlameHandsCost.get(), 3600), Items.FLINT_AND_STEEL);
        this.register(new PotionBrewEffect(GoetyEffects.FLAMMABLE, BrewConfig.FlammableCost.get(), 1800), Items.GRASS);
        this.register(new PotionBrewEffect(GoetyEffects.FLIMSY, BrewConfig.FlimsyCost.get(), 1800), Items.FEATHER);
        this.register(new PotionBrewEffect(GoetyEffects.FORTUNATE, BrewConfig.FortunateCost.get(), BrewConfig.FortunateCapacity.get(), 1800), Items.DIAMOND);
        this.register(new PotionBrewEffect(GoetyEffects.FREEZING, BrewConfig.FreezingCost.get(), 900), Items.POWDER_SNOW_BUCKET);
        this.register(new PotionBrewEffect(GoetyEffects.FROG_LEG, BrewConfig.SwiftSwimCost.get(), 3600), ModItems.FEET_OF_FROG);
        ...
        this.register(new PotionBrewEffect(GoetyEffects.PRESSURE, BrewConfig.PressureCost.get(), 1800), Items.SPYGLASS);
        this.register(new PotionBrewEffect(GoetyEffects.RADIANCE, BrewConfig.RadianceCost.get(), BrewConfig.RadianceCapacity.get(), 3600), Items.JACK_O_LANTERN);
        this.register(new PotionBrewEffect(GoetyEffects.RALLYING, BrewConfig.RallyingCost.get(), BrewConfig.RallyingCapacity.get(), 3600), Items.GOAT_HORN);
        this.register(new PotionBrewEffect(GoetyEffects.REPULSIVE, BrewConfig.RepulsiveCost.get(), 1800), Items.PISTON);
        ...
        this.register(new PotionBrewEffect(GoetyEffects.SWIRLING, BrewConfig.SwirlingCost.get(), BrewConfig.SwirlingCapacity.get(), 1800), Items.IRON_SWORD);
        this.register(new PotionBrewEffect(GoetyEffects.TRIPPING, BrewConfig.TrippingCost.get(), 1800), Items.CRACKED_STONE_BRICKS);
        this.register(new PotionBrewEffect(GoetyEffects.VENOMOUS_HANDS, BrewConfig.VenomousHandsCost.get(), 3600), ModItems.VENOMOUS_FANG);
        this.register(new PotionBrewEffect(GoetyEffects.VOID_TOUCHED, BrewConfig.VoidTouchedCost.get(), BrewConfig.VoidTouchedCapacity.get(), 1800), ModItems.VOID_BOTTLE);
        ...
        this.register(new PurifyBrewEffect("purify_debuff", BrewConfig.PurifyDebuffsCost.get(), BrewConfig.PurifyDebuffsCapacity.get(), MobEffectCategory.BENEFICIAL, 0x385858, true), ModItems.WARTFUL_EGG);
        this.register(new PurifyBrewEffect("purify_buff", BrewConfig.PurifyBuffsCost.get(), BrewConfig.PurifyBuffsCapacity.get(), MobEffectCategory.HARMFUL, 0x374a4a, false), ModItems.WARPED_WARTFUL_EGG);
        this.register(new PruningBlockEffect(BrewConfig.PruningCost.get()), Items.STONE_HOE);
        this.register(new RaiseDeadBrewEffect(BrewConfig.RaiseDeadCost.get(), BrewConfig.RaiseDeadCapacity.get()), ModItems.GRAVE_DUST);
        ...
        this.register(new WebbedBrewEffect(BrewConfig.WebbedCost.get(), BrewConfig.WebbedCapacity.get()), ModBlocks.SPIDER_NEST.asItem());
        ...
        for (EntityType<?> entityType : BuiltInRegistries.ENTITY_TYPE) {
            ...
            if (entityType.getDescriptionId().contains("endermite")) {
                brewEffect = new PotionBrewEffect(GoetyEffects.ENDER_FLUX, BrewConfig.EnderFluxCost.get(), 900);
            }
            ...
            if (entityType == EntityType.SNOW_GOLEM) {
                brewEffect = new PotionBrewEffect(GoetyEffects.SNOW_SKIN, BrewConfig.SnowSkinCost.get(), BrewConfig.SnowSkinCapacity.get(), 1800);
            }
