...
public class TropicalSlimeServant extends SlimeServant {
    ...
    public static AttributeSupplier.Builder setCustomAttributes() {
        return Mob.createMobAttributes()
                ...
                .add(ModAttributes.SWIM_SPEED, 0.1D);
    }
    ...
    protected SoundEvent getHurtSound(DamageSource p_33631_) {
        if (this.isTiny()) {
            return ModSounds.TROPICAL_SLIME_SMALL_HURT;
        } else if (this.isMedium()) {
            return ModSounds.TROPICAL_SLIME_MEDIUM_HURT;
        } else if (this.isLarge()) {
            return ModSounds.TROPICAL_SLIME_LARGE_HURT;
        }
        return ModSounds.TROPICAL_SLIME_SMALL_HURT;
    }
    ...
    protected SoundEvent getDeathSound() {
        if (this.isTiny()) {
            return ModSounds.TROPICAL_SLIME_SMALL_DEATH;
        } else if (this.isMedium()) {
            return ModSounds.TROPICAL_SLIME_MEDIUM_DEATH;
        } else if (this.isLarge()) {
            return ModSounds.TROPICAL_SLIME_LARGE_DEATH;
        }
        return ModSounds.TROPICAL_SLIME_SMALL_DEATH;
    }
    ...
    protected SoundEvent getSquishSound() {
        if (this.isTiny()) {
            return ModSounds.TROPICAL_SLIME_SMALL_SQUISH;
        } else if (this.isMedium()) {
            return ModSounds.TROPICAL_SLIME_MEDIUM_SQUISH;
        } else if (this.isLarge()) {
            return ModSounds.TROPICAL_SLIME_LARGE_SQUISH;
        }
        return ModSounds.TROPICAL_SLIME_SMALL_SQUISH;
    }
    ...
    protected SoundEvent getJumpSound() {
        if (this.isTiny()) {
            return ModSounds.TROPICAL_SLIME_SMALL_JUMP;
        } else if (this.isMedium()) {
            return ModSounds.TROPICAL_SLIME_MEDIUM_JUMP;
        } else if (this.isLarge()) {
            return ModSounds.TROPICAL_SLIME_LARGE_JUMP;
        }
        return ModSounds.TROPICAL_SLIME_SMALL_JUMP;
    }
    ...
    protected SoundEvent getAttackSound() {
        if (this.isTiny()) {
            return ModSounds.TROPICAL_SLIME_SMALL_ATTACK;
        } else if (this.isMedium()) {
            return ModSounds.TROPICAL_SLIME_MEDIUM_ATTACK;
        } else if (this.isLarge()) {
            return ModSounds.TROPICAL_SLIME_LARGE_ATTACK;
        }
        return ModSounds.TROPICAL_SLIME_SMALL_ATTACK;
    }
        ...
        public void tick() {
            ...
            if (this.operation != Operation.MOVE_TO) {
                ...
                if (this.mob.isInWater() && !this.mob.onGround()) {
                    ...
                    float f1 = (float) (this.speedModifier * this.mob.getAttributeValue(ModAttributes.SWIM_SPEED));
