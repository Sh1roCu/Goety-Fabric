...
public class CryologerServant extends SpellcasterIllagerServant implements IBreathing {
    ...
    public static ItemStack STAFF = new ItemStack(ModItems.FROST_STAFF);
            ...
            if (this.getIdol() == null) {
                if (this.getTrueOwner() != null) {
                    if (CuriosFinder.hasNamelessSet(this.getTrueOwner())) {
                        BoundCryologer servant = this.convertTo(ModEntityType.BOUND_CRYOLOGER, true);
                        if (servant != null) {
    ...
    protected ResourceLocation getDefaultLootTable() {
        if (this.isNatural()){
            return ModEntityType.CRYOLOGER.getDefaultLootTable();
        } else {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.CRYOLOGER_AMBIENT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.CRYOLOGER_DEATH;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.CRYOLOGER_HURT;
    }
    ...
    public SoundEvent getCelebrateSound() {
        return ModSounds.CRYOLOGER_CELEBRATE;
    }
    ...
    class HailSpellGoal extends CryologerUseSpellGoal {
        ...
        protected SoundEvent getSpellPrepareSound() {
            return ModSounds.CRYOLOGER_HAIL;
        }
    }
    ...
    class WallSpellGoal extends CryologerUseSpellGoal {
        ...
        protected void performSpellCasting() {
            if (CryologerServant.this.getTarget() != null) {
                ...
                if (random == 0) {
                    ...
                    WandUtil.summonLesserSquareTrap(CryologerServant.this, target.blockPosition(), ModEntityType.GLACIAL_WALL, rowToRemove, 1);
                } else if (random == 1) {
                    WandUtil.summonWallTrap(CryologerServant.this, target, ModEntityType.GLACIAL_WALL, 3, 1);
                } else {
                    WandUtil.summonRandomPillarsTrap(CryologerServant.this, target, ModEntityType.GLACIAL_WALL, 6, 1);
                }
            }
        }
        ...
        @Override
        protected SoundEvent getSpellPrepareSound() {
            return ModSounds.CRYOLOGER_WALL;
        }
    }
    ...
    class ChunkSpellGoal extends CryologerUseSpellGoal {
        ...
        @Override
        protected SoundEvent getSpellPrepareSound() {
            return ModSounds.CRYOLOGER_CHUNK;
        }
    }
}
