...
public class MountaineerServant extends AbstractIllagerServant {
    ...
    protected void populateDefaultEquipmentSlots(RandomSource p_219149_, DifficultyInstance p_219150_) {
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ModItems.IRON_ICE_AXE));
        this.setDropChance(EquipmentSlot.MAINHAND, 0.0F);
    }

    @Override
    protected SoundEvent getAmbientSound() {
        return ModSounds.MOUNTAINEER_AMBIENT;
    }

    @Override
    protected SoundEvent getHurtSound(@NotNull DamageSource p_34103_) {
        return ModSounds.MOUNTAINEER_HURT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.MOUNTAINEER_DEATH;
    }

    @Override
    public SoundEvent getCelebrateSound() {
        return ModSounds.MOUNTAINEER_CELEBRATE;
    }

    /*@Override
    public void swing(InteractionHand pHand) {
        super.swing(pHand);
        this.playSound(ModSounds.MOUNTAINEER_ATTACK);
    }*/
    ...
    public boolean isClimbableBlock(BlockPos blockPos) {
        ...
        return (blockState.is(BlockTags.ICE)
                || blockState.is(Blocks.STONE/*Tags.Blocks.STONE*/)
                || blockState.is(Blocks.COBBLESTONE/*Tags.Blocks.COBBLESTONE*/)
