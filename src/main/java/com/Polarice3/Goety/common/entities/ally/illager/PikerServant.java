...
public class PikerServant extends AbstractIllagerServant {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.PIKER_AMBIENT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.PIKER_DEATH;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.PIKER_HURT;
    }

    @Override
    protected void playStepSound(BlockPos p_20135_, BlockState p_20136_) {
        this.playSound(ModSounds.PIKER_STEP, 1.0F, 1.0F);
    }
    ...
    public SoundEvent getCelebrateSound() {
        return ModSounds.PIKER_CELEBRATE;
    }
    ...
    protected ResourceLocation getDefaultLootTable() {
        if (this.isNatural()){
            return ModEntityType.PIKER.getDefaultLootTable();
        } else {
        ...
        public void tick() {
            if (PikerServant.this.getTarget() != null && PikerServant.this.getTarget().isAlive()) {
                ...
                if (PikerServant.this.attackTick == 1) {
                    PikerServant.this.playSound(ModSounds.PIKER_SWING, PikerServant.this.getSoundVolume(), PikerServant.this.getVoicePitch());
                }
                if (PikerServant.this.attackTick == 8) {
                    if (PikerServant.this.targetClose(livingentity, d0)) {
                        if (PikerServant.this.doHurtTarget(livingentity)) {
                            PikerServant.this.playSound(ModSounds.PIKER_PIKE, PikerServant.this.getSoundVolume(), PikerServant.this.getVoicePitch());
