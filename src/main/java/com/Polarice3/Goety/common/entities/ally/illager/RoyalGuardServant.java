...
public class RoyalGuardServant extends AbstractIllagerServant implements IShielded {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new ShieldedMeleeGoal<>(this) {
            public void playPreAttack() {
                this.mob.playSound(ModSounds.ROYAL_GUARD_PRE_ATTACK, this.mob.getSoundVolume() * 0.5F, this.mob.getVoicePitch() * 0.75F);
            }
            ...
            if (this.getIdol() == null) {
                if (this.getTrueOwner() != null) {
                    if (CuriosFinder.hasNamelessSet(this.getTrueOwner())) {
                        ZombieRoyalGuardServant servant = this.convertTo(ModEntityType.BLACKGUARD_VARIANT_SERVANT, true);
                        if (servant != null) {
    ...
    protected void playStepSound(BlockPos pos, BlockState blockIn) {
        this.playSound(ModSounds.ROYAL_GUARD_STEP, 0.15F, 1.0F);
    }
