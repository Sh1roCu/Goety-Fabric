...
public class StormCasterServant extends AbstractIllagerServant {
    ...
    public static ItemStack STAFF = new ItemStack(ModItems.STORM_STAFF);
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.STORM_CASTER_AMBIENT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.STORM_CASTER_DEATH;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.STORM_CASTER_HURT;
    }
            ...
            if (this.getIdol() == null) {
                if (this.getTrueOwner() != null) {
                    if (CuriosFinder.hasNamelessSet(this.getTrueOwner())) {
                        BoundStormCaster servant = this.convertTo(ModEntityType.BOUND_STORM_CASTER, true);
                        if (servant != null) {
    ...
    protected ResourceLocation getDefaultLootTable() {
        if (this.isNatural()){
            return ModEntityType.STORM_CASTER.getDefaultLootTable();
        } else {
    ...
    public void tick() {
        ...
        if (this.level.isClientSide) {
            ...
            if (this.isAlive()) {
                ...
                ServerParticleUtil.circularParticles(serverLevel, ModParticleTypes.STATION_CULT_SPELL, this, colorUtil.red(), colorUtil.green(), colorUtil.blue(), 0.5F);
                if (serverLevel.random.nextInt(20) == 0) {
                    ...
                    ModNetwork.sendToALL(serverLevel.getServer(), SLightningPacket.ID, SLightningPacket.encode(vec3, vec31, 2));
                }
            }
        }
    }
    ...
    protected SoundEvent getCastingSoundEvent() {
        return ModSounds.WIND;
    }

    @Override
    public SoundEvent getCelebrateSound() {
        return ModSounds.STORM_CASTER_CELEBRATE;
    }
    ...
    class MonsoonSpellGoal extends StormCasterUseSpellGoal {
        ...
        protected SoundEvent getSpellPrepareSound() {
            return ModSounds.STORM_CASTER_MONSOON;
        }
    }
    ...
    class DischargeSpellGoal extends StormCasterUseSpellGoal {
        ...
        @Override
        protected SoundEvent getSpellPrepareSound() {
            return ModSounds.STORM_CASTER_DISCHARGE;
        }
