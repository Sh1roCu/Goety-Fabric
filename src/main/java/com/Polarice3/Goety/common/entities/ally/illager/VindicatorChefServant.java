...
public class VindicatorChefServant extends VindicatorServant {
    ...
    public static class CookingGoal extends Goal {
        ...
        protected void moveMobToBlock() {
            ...
            this.illager.getNavigation().moveTo((double) ((float) this.furnace.getX()) + 0.5D, this.furnace.getY() + 1, (double) ((float) this.furnace.getZ()) + 0.5D, 0.75F);
        }
            ...
            if (this.illager.level instanceof ServerLevel serverLevel) {
                if (this.illager.distanceToSqr(Vec3.atCenterOf(this.furnace)) > Mth.square(2)) {
                    ...
                    if (this.shouldRecalculatePath()) {
                        this.illager.getNavigation().moveTo((double) ((float) this.furnace.getX()) + 0.5D, this.furnace.getY(), (double) ((float) this.furnace.getZ()) + 0.5D, 0.75F);
                    }
