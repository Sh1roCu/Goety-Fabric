...
public class WindCallerServant extends SpellcasterIllagerServant {
    ...
    public ItemStack staff = new ItemStack(ModItems.WIND_STAFF);
            ...
            if (this.getIdol() == null) {
                if (this.getTrueOwner() != null) {
                    if (CuriosFinder.hasNamelessSet(this.getTrueOwner())) {
                        BoundWindCaller servant = this.convertTo(ModEntityType.BOUND_WIND_CALLER, true);
                        if (servant != null) {
    ...
    public SoundEvent getCelebrateSound() {
        return ModSounds.WIND_CALLER_AMBIENT;
    }
    ...
    protected SoundEvent getDeathSound() {
        return ModSounds.WIND_CALLER_DEATH;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource p_32654_) {
        return ModSounds.WIND_CALLER_HURT;
    }
    ...
    public static class BlastGoal extends Goal {
        ...
        public void start() {
            ...
            this.windCaller.playSound(ModSounds.WIND_CALLER_BLAST, 1.2F, 1.0F);
            this.spellTick = 0;
        }
        ...
        public void tick() {
            ...
            if (this.windCaller.distanceTo(this.windCaller.getTarget()) <= 13.0D || this.attack) {
                if (!this.attack) {
                    ...
                    this.windCaller.playSound(ModSounds.WIND_CALLER_UPDRAFT, 1.2F, 1.0F);
                    this.attack = true;
                }
