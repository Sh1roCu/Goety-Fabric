...
public class ModIllagerType implements ITrainIllager {
    ...
    public boolean mobCanTrainTo(Mob mob, Level level, BlockPos blockPos, int range) {
        ...
        if (entityType == ModEntityType.STORM_CASTER_SERVANT) {
            return mob.getType() == ModEntityType.GEOMANCER_SERVANT || mob.getType() == ModEntityType.WIND_CALLER_SERVANT;
        } else if (entityType == ModEntityType.CRYOLOGER_SERVANT) {
            return mob.getType() == ModEntityType.ICEOLOGER_SERVANT;
        } else if (entityType == ModEntityType.VINDICATOR_CHEF_SERVANT || entityType == ModEntityType.MOUNTAINEER_SERVANT || entityType == ModEntityType.CRUSHER_SERVANT) {
            return mob.getType() == ModEntityType.VINDICATOR_SERVANT;
        } else if (entityType == ModEntityType.ROYAL_GUARD_SERVANT) {
            return mob.getType() == ModEntityType.VINDICATOR_SERVANT && mob instanceof IOwned owned && owned.getTrueOwner() instanceof Player player && SEHelper.hasResearch(player, ResearchList.FRONT);
        } else if (entityType == ModEntityType.IMPERIAL_GUARD_SERVANT) {
            return mob.getType() == ModEntityType.PILLAGER_SERVANT && mob instanceof IOwned owned && owned.getTrueOwner() instanceof Player player && SEHelper.hasResearch(player, ResearchList.FRONT);
        } else if (entityType == ModEntityType.PIKER_SERVANT) {
    ...
    public EntityType<? extends Mob> getIllager(Level level, BlockPos blockPos, int range) {
        ...
        if (checker.hasBlocks(blockState -> blockState.is(Blocks.HAY_BLOCK) || blockState.is(Blocks.TARGET), 2)
                ...
                && checker.hasBlocks(blockState -> blockState.is(BlockTags.WOODEN_FENCES/*Tags.Blocks.FENCES_WOODEN*/), 16)
                && checker.hasBlocks(blockState -> blockState.is(BlockTags.WOOL), 20)) {
            return ModEntityType.PILLAGER_SERVANT;
            ...
            return ModEntityType.VINDICATOR_SERVANT;
            ...
            return ModEntityType.VINDICATOR_CHEF_SERVANT;
            ...
            return ModEntityType.MOUNTAINEER_SERVANT;
            ...
            return ModEntityType.CRUSHER_SERVANT;
            ...
            return ModEntityType.ROYAL_GUARD_SERVANT;
            ...
            return ModEntityType.EVOKER_SERVANT;
        } else if (checker.hasBlocks(blockState -> blockState.is(Blocks.AMETHYST_BLOCK/*Tags.Blocks.STORAGE_BLOCKS_AMETHYST*/), 16)
                && checker.hasBlocks(blockState -> blockState.getBlock().getDescriptionId().contains("deepslate"), 64)
                && checker.hasBlocks(blockState -> blockState.is(ModBlocks.CREEPER_TOTEM), 16)) {
            return ModEntityType.GEOMANCER_SERVANT;
                ...
                && checker.hasBlocks(blockState -> blockState.is(ModBlocks.FREEZING_LAMP), 4)) {
            return ModEntityType.ICEOLOGER_SERVANT;
            ...
            return ModEntityType.WIND_CALLER_SERVANT;
                ...
                && checker.hasBlocks(blockState -> blockState.is(ModBlocks.CREEPER_TOTEM), 16)
                && level.getBiome(blockPos).value().coldEnoughToSnow(blockPos)) {
            return ModEntityType.CRYOLOGER_SERVANT;
                ...
                && level.isThundering()) {
            return ModEntityType.STORM_CASTER_SERVANT;
        }
        return null;
    }
}
