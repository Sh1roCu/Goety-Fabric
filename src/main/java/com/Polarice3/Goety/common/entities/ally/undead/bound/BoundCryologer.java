        ...
        protected void performSpellCasting() {
            if (BoundCryologer.this.getTarget() != null) {
                ...
                if (random == 0) {
                    ...
                    WandUtil.summonLesserSquareTrap(BoundCryologer.this, target.blockPosition(), ModEntityType.GLACIAL_WALL, rowToRemove, 1);
                } else if (random == 1) {
                    WandUtil.summonWallTrap(BoundCryologer.this, target, ModEntityType.GLACIAL_WALL, 3, 1);
                } else {
                    WandUtil.summonRandomPillarsTrap(BoundCryologer.this, target, ModEntityType.GLACIAL_WALL, 6, 1);
                }
            }
        }
