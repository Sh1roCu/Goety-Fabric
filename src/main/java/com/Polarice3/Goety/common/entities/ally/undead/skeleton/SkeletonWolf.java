...
public class SkeletonWolf extends AnimalSummon {
    ...
    protected void playStepSound(BlockPos p_30415_, BlockState p_30416_) {
        this.playSound(ModSounds.SKELETON_WOLF_STEP, 0.15F, 1.0F);
    }
    ...
    protected SoundEvent getAmbientSound() {
        if (this.isAggressive()) {
            return ModSounds.SKELETON_WOLF_GROWL;
        } else if (this.random.nextInt(3) == 0) {
            return this.getTrueOwner() != null && this.getHealth() < this.getMaxHealth() / 2.0F ? ModSounds.SKELETON_WOLF_WHINE : ModSounds.SKELETON_WOLF_PANT;
        } else {
            return ModSounds.SKELETON_WOLF_AMBIENT;
        }
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource p_30424_) {
        return ModSounds.SKELETON_WOLF_HURT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.SKELETON_WOLF_DEATH;
    }
        ...
        if (this.isAlive()) {
            ...
            if (this.isInWaterRainOrBubble()) {
                ...
                if (this.shakeAnim == 0.0F) {
                    this.playSound(ModSounds.SKELETON_WOLF_SHAKE, this.getSoundVolume(), (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
    ...
    public boolean isFood(ItemStack p_30440_) {
        return p_30440_.is(Items.BONE /*ConventionalItemTags.BONES*/);
    }
    ...
    public static class HowlGoal extends Goal {
        ...
        public void start() {
            ...
            this.wolf.playSound(ModSounds.SKELETON_WOLF_HOWL, 1.0F, 1.0F);
