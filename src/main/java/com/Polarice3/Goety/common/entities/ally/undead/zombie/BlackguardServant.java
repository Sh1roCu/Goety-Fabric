...
public class BlackguardServant extends ZombieServant {
    ...
    public InteractionResult mobInteract(Player pPlayer, InteractionHand pHand) {
        ...
        if (this.getTrueOwner() != null && pPlayer == this.getTrueOwner()) {
            ...
            if (!this.level.isClientSide) {
                if (!this.hasShield() && itemstack.is(ConventionalItemTags.IRON_INGOTS) && this.getTarget() == null && this.hurtTime <= 0) {
                    if (!pPlayer.getAbilities().instabuild) {
                        itemstack.shrink(1);
                    }
                    this.setShield(true);
    ...
    class MeleeGoal extends Goal {
        ...
        public void tick() {
            ...
            if (BlackguardServant.this.attackTick == 1) {
                BlackguardServant.this.playSound(ModSounds.BLACKGUARD_PRE_ATTACK, BlackguardServant.this.getSoundVolume() + 1.0F, BlackguardServant.this.getVoicePitch());
            }
            if (BlackguardServant.this.attackTick == 9) {
                BlackguardServant.this.playSound(ModSounds.BLACKGUARD_SMASH, BlackguardServant.this.getSoundVolume() + 1.0F, BlackguardServant.this.getVoicePitch());
            }
