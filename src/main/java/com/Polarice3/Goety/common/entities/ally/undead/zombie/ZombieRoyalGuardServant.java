...
public class ZombieRoyalGuardServant extends BlackguardServant {
    ...
    public EntityType<?> getVariant(Level level, BlockPos blockPos) {
        return ModEntityType.BLACKGUARD_VARIANT_SERVANT;
    }
    ...
    private void finishConversion(ServerLevel serverLevel) {
        ...
        Entity servant = MobUtil.convertTo(this, ModEntityType.ROYAL_GUARD_SERVANT, true, player);
        if (servant instanceof VindicatorServant vindicator) {
            ...
            ServerLivingEntityEvents.MOB_CONVERSION.invoker().onConversion(this, vindicator, true);
        }
    }
