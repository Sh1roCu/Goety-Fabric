        ...
        if (this.level.isClientSide && this.isSpellcasting() && this.isAlive()) {
            ...
            if (this instanceof Apostle) {
                ...
                if (this.getMainArm() == HumanoidArm.RIGHT) {
                    this.level.addParticle(ModParticleTypes.CULT_SPELL, this.getX() + (double) f1 * 0.6D, this.getY() + 1.8D, this.getZ() + (double) f2 * 0.6D, d0, d1, d2);
                } else {
                    this.level.addParticle(ModParticleTypes.CULT_SPELL, this.getX() - (double) f1 * 0.6D, this.getY() + 1.8D, this.getZ() - (double) f2 * 0.6D, d0, d1, d2);
                }
            } else {
                for (int i = 0; i < this.level.random.nextInt(35) + 10; ++i) {
                    ...
                    this.level.addParticle(ModParticleTypes.CULT_SPELL, this.getX(), this.getEyeY(), this.getZ(), d0, d1, d2);
                }
            }
        }
