    ...
    class MeleeGoal extends Goal {
        ...
        public void tick() {
            ...
            if (Crusher.this.attackTick == 11) {
                Crusher.this.playSound(ModSounds.HAMMER_SWING);
            }
            if (Crusher.this.attackTick == 13) {
                ...
                Crusher.this.playSound(ModSounds.HAMMER_IMPACT);
                Crusher.this.playSound(ModSounds.DIRT_DEBRIS);
                if (Crusher.this.isStorm()) {
                    Crusher.this.playSound(ModSounds.THUNDER_STRIKE_FAST);
                }
            ...
            if (Crusher.this.level instanceof ServerLevel serverLevel) {
                if (Crusher.this.isStorm() && target instanceof LivingEntity livingEntity) {
                    ...
                    if (lightningRod.isPresent()) {
                        ...
                        serverLevel.playSound(null, Crusher.this.getX(), Crusher.this.getY(), Crusher.this.getZ(), ModSounds.THUNDERBOLT, Crusher.this.getSoundSource(), 1.0F, 1.0F);
                    } else {
