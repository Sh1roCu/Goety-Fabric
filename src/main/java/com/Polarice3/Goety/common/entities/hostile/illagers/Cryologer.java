        ...
        protected void performSpellCasting() {
            if (Cryologer.this.getTarget() != null) {
                ...
                if (random == 0) {
                    ...
                    WandUtil.summonLesserSquareTrap(Cryologer.this, target.blockPosition(), ModEntityType.GLACIAL_WALL, rowToRemove, 1);
                } else if (random == 1) {
                    WandUtil.summonWallTrap(Cryologer.this, target, ModEntityType.GLACIAL_WALL, 3, 1);
                } else {
                    WandUtil.summonRandomPillarsTrap(Cryologer.this, target, ModEntityType.GLACIAL_WALL, 6, 1);
                }
            }
        }
