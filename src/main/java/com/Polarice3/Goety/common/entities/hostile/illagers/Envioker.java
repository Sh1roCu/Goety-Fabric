...
public class Envioker extends HuntingIllagerEntity {
    ...
    class SummonSpellGoal extends SpellcasterUseSpellGoal {
        ...
        protected void performSpellCasting() {
            ...
            Tormentor tormentorEntity = ModEntityType.TORMENTOR.create(Envioker.this.level);
            if (tormentorEntity != null) {
                tormentorEntity.moveTo(blockpos, 0.0F, 0.0F);
                tormentorEntity.finalizeSpawn(serverworld, Envioker.this.level.getCurrentDifficultyAt(blockpos), MobSpawnType.MOB_SUMMONED, null, null);
