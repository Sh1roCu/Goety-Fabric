...
public class Inquillager extends HuntingIllagerEntity {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.INQUILLAGER_AMBIENT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.INQUILLAGER_DEATH;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.INQUILLAGER_HURT;
    }

    @Override
    public SoundEvent getCelebrateSound() {
        return ModSounds.INQUILLAGER_CELEBRATE;
    }
            ...
            if (livingEntity != null) {
                ...
                if (this.bombTimer >= 60) {
                    ...
                    if (!this.inquillager.isSilent()) {
                        this.inquillager.level.playSound(null, this.inquillager.getX(), this.inquillager.getY(), this.inquillager.getZ(), SoundEvents.WITCH_THROW, this.inquillager.getSoundSource(), 1.0F, 0.8F + this.inquillager.random.nextFloat() * 0.4F);
                    }
