...
public class Tormentor extends AbstractIllager implements ICustomAttributes {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.TORMENTOR_AMBIENT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.TORMENTOR_DEATH;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.TORMENTOR_HURT;
    }
    ...
    public SoundEvent getCelebrateSound() {
        return ModSounds.TORMENTOR_CELEBRATE;
    }
    ...
    class ChargeAttackGoal extends Goal {
        ...
        public void start() {
            ...
            if (livingentity != null) {
                ...
                Tormentor.this.playSound(ModSounds.TORMENTOR_CHARGE, 1.0F, 1.0F);
            }
        }
