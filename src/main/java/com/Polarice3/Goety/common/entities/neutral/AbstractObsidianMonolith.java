                ...
                if (this.startSpreading()) {
                    ...
                    if (this.startUp > 0) {
                        if (this.level.isEmptyBlock(BlockPos.containing(skyVec))) {
                            ...
                            ServerParticleUtil.addReverseAuraParticles(serverLevel, ModParticleTypes.SPELL_CLOUD, skyVec, radius / 2.0F);
                            ServerParticleUtil.addAuraParticles(serverLevel, ModParticleTypes.SPELL_CLOUD, skyVec, radius);
                        }
                    }
                }
            }
