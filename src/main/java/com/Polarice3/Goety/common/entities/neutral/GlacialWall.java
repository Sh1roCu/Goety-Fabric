...
public class GlacialWall extends AbstractMonolith {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag) {
        ...
        if (this.canSpawn(pLevel.getLevel())) {
            this.playSound(ModSounds.WALL_SPAWN, 1.0F, 2.0F);
            this.playSound(ModSounds.WALL_ERUPT, 1.0F, 2.0F);
    ...
    public void die(DamageSource cause) {
        ...
        this.playSound(ModSounds.ICE_SPIKE_HIT, 1.0F, (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 0.5F);
