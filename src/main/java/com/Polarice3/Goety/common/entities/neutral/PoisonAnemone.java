...
public class PoisonAnemone extends PoisonQuillVine {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.POISON_ANEMONE_AMBIENT;
    }

    @Nullable
    @Override
    protected SoundEvent getHurtSound(@NotNull DamageSource p_21239_) {
        return ModSounds.POISON_ANEMONE_HURT;
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.POISON_ANEMONE_DEATH;
    }

    @Override
    protected SoundEvent getBurstSound() {
        return ModSounds.POISON_ANEMONE_BURST;
    }
    ...
    protected SoundEvent getCloseSound() {
        return ModSounds.POISON_ANEMONE_CLOSE;
    }

    @Override
    protected SoundEvent getOpenSound() {
        return ModSounds.POISON_ANEMONE_OPEN;
    }
    ...
    public void shootQuill(@NotNull LivingEntity target) {
        ...
        if (this.level.addFreshEntity(quill)) {
            this.playSound(ModSounds.POISON_ANEMONE_SHOOT);
        }
    }
