...
public class PoisonQuillVine extends AbstractVine {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.POISON_QUILL_VINE_AMBIENT;
    }

    @Nullable
    @Override
    protected SoundEvent getHurtSound(@NotNull DamageSource p_21239_) {
        return ModSounds.POISON_QUILL_VINE_HURT;
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.POISON_QUILL_VINE_DEATH;
    }

    @Override
    protected SoundEvent getBurstSound() {
        return ModSounds.POISON_QUILL_VINE_BURST;
    }
    ...
    protected SoundEvent getCloseSound() {
        return ModSounds.POISON_QUILL_VINE_CLOSE;
    }

    protected SoundEvent getOpenSound() {
        return ModSounds.POISON_QUILL_VINE_OPEN;
    }
    ...
    public void shootQuill(@NotNull LivingEntity target) {
        ...
        if (this.level.addFreshEntity(quill)) {
            this.playSound(ModSounds.POISON_QUILL_VINE_SHOOT);
        }
    }
    ...
    public ItemStack getSeed() {
        return new ItemStack(ModItems.POISON_QUILL_SEED);
    }
