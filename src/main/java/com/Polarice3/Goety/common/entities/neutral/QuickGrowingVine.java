...
public class QuickGrowingVine extends AbstractVine {
    ...
    protected SoundEvent getHurtSound(DamageSource p_21239_) {
        return ModSounds.QUICK_GROWING_VINE_HURT;
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.QUICK_GROWING_VINE_DEATH;
    }

    @Override
    protected SoundEvent getBurstSound() {
        return ModSounds.QUICK_GROWING_VINE_BURST;
    }

    @Override
    protected SoundEvent getBurrowSound() {
        return ModSounds.QUICK_GROWING_VINE_BURROW;
    }
    ...
    public ItemStack getSeed() {
        return new ItemStack(ModItems.QUICK_GROWING_SEED);
    }
}
