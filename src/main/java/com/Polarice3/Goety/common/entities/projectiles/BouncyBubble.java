...
public class BouncyBubble extends SpellHurtingProjectile {
    ...
    public BouncyBubble(double pX, double pY, double pZ, double pXPower, double pYPower, double pZPower, Level pLevel) {
        super(ModEntityType.BOUNCY_BUBBLE, pX, pY, pZ, pXPower, pYPower, pZPower, pLevel);
    }

    public BouncyBubble(LivingEntity pShooter, double pXPower, double pYPower, double pZPower, Level pLevel) {
        super(ModEntityType.BOUNCY_BUBBLE, pShooter, pXPower, pYPower, pZPower, pLevel);
    }
    ...
    public void explode() {
        ...
        if (!this.level.isClientSide) {
            ...
            if (this.level instanceof ServerLevel serverLevel) {
                ...
                for (int i = 0; i < 8; ++i) {
                    serverLevel.sendParticles(ModParticleTypes.WATER_TRAIL, this.getX(), this.getY(), this.getZ(), 1, 0, 0, 0, 0.15);
                }
            }
