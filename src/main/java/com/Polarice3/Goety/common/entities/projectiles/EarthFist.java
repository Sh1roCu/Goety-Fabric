...
public class EarthFist extends SpellEntity {
    ...
    public EarthFist(Level pLevel, LivingEntity pOwner) {
        this(ModEntityType.EARTH_FIST, pLevel);
    ...
    public void handleEntityEvent(byte p_36935_) {
        ...
        if (p_36935_ == 4) {
            ...
            this.refreshDimensions();
            if (!this.isSilent()) {
                this.level.playLocalSound(this.getX(), this.getY(), this.getZ(), ModSounds.WALL_ERUPT, this.getSoundSource(), 1.0F, this.random.nextFloat() * 0.2F + 0.85F, false);
            }
        } else if (p_36935_ == 5) {
