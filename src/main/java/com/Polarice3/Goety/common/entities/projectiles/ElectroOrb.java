...
public class ElectroOrb extends SpellThrowableProjectile {
    ...
    public ElectroOrb(Level pLevel, LivingEntity pOwner, @Nullable LivingEntity pTarget) {
        super(ModEntityType.ELECTRO_ORB, pOwner, pLevel);
        if (pTarget != null) {
    ...
    public void finalizeExplosion() {
        if (this.level instanceof ServerLevel serverLevel) {
            ...
            if (this.isStaff()) {
                ...
                serverLevel.playSound(null, this.getX(), this.getY(), this.getZ(), ModSounds.REDSTONE_EXPLODE, this.getSoundSource(), 1.0F, 1.0F);
            }
        }
    }
