...
public class EntangleVines extends TangleEntity {
    ...
    public EntangleVines(Level p_19871_, LivingEntity owner, Entity target) {
        super(ModEntityType.ENTANGLE_VINES, p_19871_, owner, target);
    }

    public EntangleVines(Level p_19871_, LivingEntity owner, BlockPos blockPos) {
        super(ModEntityType.ENTANGLE_VINES, p_19871_, owner, blockPos);
    }
    ...
    public void burst() {
        ...
        this.playSound(ModSounds.VINE_TRAP_BURST, 2.0F, 1.0F);
        this.playSound(ModSounds.VINE_TRAP_HOLD, 1.0F, 1.0F);
    }
