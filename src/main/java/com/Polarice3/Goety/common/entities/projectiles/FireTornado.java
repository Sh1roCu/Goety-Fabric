...
public class FireTornado extends AbstractCyclone {
    ...
    public FireTornado(Level level, LivingEntity shooter, double xPower, double yPower, double zPower) {
        super(ModEntityType.FIRE_TORNADO, shooter, xPower, yPower, zPower, level);
        this.setSize(2.0F);
    }
    ...
    public FireTornado(Level p_i1795_1_, double p_i1795_2_, double p_i1795_4_, double p_i1795_6_, double p_i1795_8_, double p_i1795_10_, double p_i1795_12_) {
        super(ModEntityType.FIRE_TORNADO, p_i1795_2_, p_i1795_4_, p_i1795_6_, p_i1795_8_, p_i1795_10_, p_i1795_12_, p_i1795_1_);
        this.setSize(2.0F);
    }
    ...
    public void tick() {
        ...
        if (this.tickCount % 20 == 0) {
            this.playSound(ModSounds.FIRE_TORNADO_AMBIENT, 1.0F, 0.5F);
        }
        if (this.getTrueOwner() != null && this.getTrueOwner().getType().is(ConventionalEntityTypeTags.BOSSES)) {
