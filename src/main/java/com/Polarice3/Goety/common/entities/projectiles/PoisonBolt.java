...
public class PoisonBolt extends SpellHurtingProjectile {
    ...
    public PoisonBolt(double pX, double pY, double pZ, double pXPower, double pYPower, double pZPower, Level pLevel) {
        super(ModEntityType.POISON_BOLT, pX, pY, pZ, pXPower, pYPower, pZPower, pLevel);
    }

    public PoisonBolt(LivingEntity pShooter, double pXPower, double pYPower, double pZPower, Level pLevel) {
        super(ModEntityType.POISON_BOLT, pShooter, pXPower, pYPower, pZPower, pLevel);
    }
    ...
    protected void onHit(HitResult p_37628_) {
        ...
        this.playSound(ModSounds.POISON_BOLT_IMPACT);
        if (!this.level.isClientSide) {
            ...
            for (int p = 0; p < 32; ++p) {
                ...
                serverLevel.sendParticles(ModParticleTypes.CULT_SPELL, d0, d1, d2, 0, colors[0], colors[1], colors[2], 1.0F);
            }
            this.discard();
        }
