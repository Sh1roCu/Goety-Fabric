...
public class RainArrow extends Arrow {
    ...
    public EntityType<?> getType() {
        return ModEntityType.RAIN_ARROW;
    }
    ...
    public void remove(RemovalReason p_146834_) {
        if (p_146834_ == RemovalReason.DISCARDED) {
            if (this.level instanceof ServerLevel serverLevel) {
                ...
                serverLevel.sendParticles(ModParticleTypes.CULT_SPELL, this.getX(), this.getY(), this.getZ(), 0, colorUtil.red, colorUtil.green, colorUtil.blue, 1.0F);
            }
        }
