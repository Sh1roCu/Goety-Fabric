...
public class SnarelingShot extends ThrowableProjectile {
    ...
    public SnarelingShot(double p_37457_, double p_37458_, double p_37459_, Level p_37460_) {
        super(ModEntityType.SNARELING_SHOT, p_37457_, p_37458_, p_37459_, p_37460_);
    }

    public SnarelingShot(LivingEntity p_37463_, Level p_37464_) {
        super(ModEntityType.SNARELING_SHOT, p_37463_, p_37464_);
    }
    ...
    public void tick() {
        ...
        for (int i = 0; i < 2; ++i) {
            this.level.addParticle(ModParticleTypes.GOO_STAIN, d0 + (this.random.nextGaussian() / 2), d1 + 0.5D + (this.random.nextGaussian() / 2), d2 + (this.random.nextGaussian() / 2), colorUtil.red(), colorUtil.green(), colorUtil.blue());
        }
    ...
    protected void onHit(HitResult pResult) {
        ...
        if (!this.level.isClientSide) {
            ...
            SnarelingGoop goop = new SnarelingGoop(ModEntityType.SNARELING_GOOP, this.level);
