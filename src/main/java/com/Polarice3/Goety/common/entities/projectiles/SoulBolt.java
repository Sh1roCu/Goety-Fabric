...
public class SoulBolt extends SpellHurtingProjectile {
    ...
    public SoulBolt(double pX, double pY, double pZ, double pXPower, double pYPower, double pZPower, Level pLevel) {
        super(ModEntityType.SOUL_BOLT, pX, pY, pZ, pXPower, pYPower, pZPower, pLevel);
    }

    public SoulBolt(LivingEntity pShooter, double pXPower, double pYPower, double pZPower, Level pLevel) {
        super(ModEntityType.SOUL_BOLT, pShooter, pXPower, pYPower, pZPower, pLevel);
    }
    ...
    protected void onHit(HitResult p_37628_) {
        ...
        this.playSound(ModSounds.BOLT_IMPACT);
        if (!this.level.isClientSide) {
            ...
            for (int p = 0; p < 32; ++p) {
                ...
                serverLevel.sendParticles(ModParticleTypes.BULLET_EFFECT, d0, d1, d2, 0, 0.45, 0.45, 0.45, 0.5F);
            }
            this.discard();
        }
