...
public class SoulBomb extends ThrowableProjectile {
    ...
    public SoulBomb(double p_37457_, double p_37458_, double p_37459_, Level p_37460_) {
        super(ModEntityType.SOUL_BOMB, p_37457_, p_37458_, p_37459_, p_37460_);
    }

    public SoulBomb(LivingEntity p_37463_, Level p_37464_) {
        super(ModEntityType.SOUL_BOMB, p_37463_, p_37464_);
    }
    ...
    protected void onHit(HitResult p_37406_) {
        ...
        if (!this.level.isClientSide) {
            ...
            ModNetwork.sendToALL(this.level.getServer(), SSoulExplodePacket.ID, SSoulExplodePacket.encode(this.blockPosition(), 2));
            this.discard();
        }
    }
}
