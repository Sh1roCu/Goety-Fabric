...
public class SwordProjectile extends AbstractArrow implements ItemSupplier {
    ...
    public SwordProjectile(double p_i48547_2_, double p_i48547_4_, double p_i48547_6_, Level p_i48547_8_) {
        super(ModEntityType.SWORD, p_i48547_2_, p_i48547_4_, p_i48547_6_, p_i48547_8_);
    }

    public SwordProjectile(LivingEntity p_i48548_2_, Level p_i48548_3_, ItemStack p_i48790_3_) {
        super(ModEntityType.SWORD, p_i48548_2_.getX(), p_i48548_2_.getY(0.5F), p_i48548_2_.getZ(), p_i48548_3_);
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        if (!this.getItem().isEmpty()) {
            f1 += EnchantmentHelper.getItemEnchantmentLevel(Enchantments.KNOCKBACK, this.getItem());
            i = EnchantmentHelper.getItemEnchantmentLevel(Enchantments.FIRE_ASPECT, this.getItem());
        }
