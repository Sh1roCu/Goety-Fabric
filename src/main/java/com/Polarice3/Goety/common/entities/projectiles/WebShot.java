...
public class WebShot extends ThrowableProjectile {
    ...
    public WebShot(double p_37457_, double p_37458_, double p_37459_, Level p_37460_) {
        super(ModEntityType.WEB_SHOT, p_37457_, p_37458_, p_37459_, p_37460_);
    }

    public WebShot(LivingEntity p_37463_, Level p_37464_) {
        super(ModEntityType.WEB_SHOT, p_37463_, p_37464_);
    }
    ...
    protected void onHit(HitResult pResult) {
        ...
        if (!this.level.isClientSide) {
            ...
            SpiderWeb spiderWeb = new SpiderWeb(ModEntityType.SPIDER_WEB, this.level);
