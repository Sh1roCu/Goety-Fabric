...
public class DelayedSummon extends Entity {
    ...
    public DelayedSummon(Level pLevel, Vec3 pPos, Entity pEntity, boolean preMade, boolean noPos, @Nullable LivingEntity pOwner) {
        this(ModEntityType.DELAYED_SUMMON, pLevel);
                ...
                if (this.entity != null) {
                    ...
                    if (this.preMade) {
                        ...
                        if (this.entity instanceof Mob mob) {
                            mob.finalizeSpawn(serverWorld, this.level.getCurrentDifficultyAt(this.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null);
                    ...
                    if (serverWorld.addFreshEntity(this.entity)) {
                        if (this.necromancy) {
                            ...
                            serverWorld.sendParticles(ModParticleTypes.GOD_RAY, this.entity.getX(), this.entity.getY(), this.entity.getZ(), 0, colorUtil.red(), colorUtil.green(), colorUtil.blue(), 1.0F);
