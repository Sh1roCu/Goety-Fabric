...
public class FireBlastTrap extends Entity implements ISpellEntity {
    ...
    public FireBlastTrap(Level worldIn, double x, double y, double z) {
        this(ModEntityType.FIRE_BLAST_TRAP, worldIn);
        this.setPos(x, y, z);
    }
    ...
    public void tick() {
        ...
        if (this.level instanceof ServerLevel serverLevel) {
            ...
            for (int k1 = 0; (float) k1 < f5; ++k1) {
                ...
                serverLevel.sendParticles(ModParticleTypes.BURNING, this.getX() + (double) f8, this.getY(), this.getZ() + (double) f9, 1, 0, 0, 0, 0);
            }
