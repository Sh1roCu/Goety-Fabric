    ...
    public void tick() {
        ...
        if (this.tickCount == 150) {
            ...
            if (this.level instanceof ServerLevel serverLevel) {
                Warden.applyDarknessAround(serverLevel, this.position(), null, 32);
            }
        }
        if (this.tickCount == 300) {
            this.playSound(ModSounds.APOSTLE_AMBIENT, 1.0F, 1.0F);
        }
        ...
        if (!this.level.isClientSide) {
            ...
            if (this.tickCount == 450) {
                ...
                Apostle apostleEntity = new Apostle(ModEntityType.APOSTLE, this.level);
