...
public class ModChestBoat extends ModBoat implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public ModChestBoat(Level p_219872_, double p_219873_, double p_219874_, double p_219875_) {
        this(ModEntityType.MOD_CHEST_BOAT, p_219872_);
    ...
    public Item getDropItem() {
        return switch (this.getModBoatType()) {
            case HAUNTED -> ModItems.HAUNTED_CHEST_BOAT;
            case ROTTEN -> ModItems.ROTTEN_CHEST_BOAT;
            case WINDSWEPT -> ModItems.WINDSWEPT_CHEST_BOAT;
            case PINE -> ModItems.PINE_CHEST_BOAT;
            case CHORUS -> ModItems.CHORUS_CHEST_BOAT;
            case CORRUPT_CHORUS -> ModItems.CORRUPT_CHORUS_CHEST_BOAT;
        };
    }
