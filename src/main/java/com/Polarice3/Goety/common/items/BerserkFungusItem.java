...
public class BerserkFungusItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41128_, Player p_41129_, InteractionHand p_41130_) {
        ...
        p_41128_.playSound(null, p_41129_.getX(), p_41129_.getY(), p_41129_.getZ(), ModSounds.BLAST_FUNGUS_THROW, SoundSource.PLAYERS, 0.5F, 0.4F / (p_41128_.getRandom().nextFloat() * 0.4F + 0.8F));
