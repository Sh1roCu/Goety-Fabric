...
public class CrypticEyeItem extends Item {
   ...
   public InteractionResultHolder<ItemStack> use(Level p_41184_, Player p_41185_, InteractionHand p_41186_) {
      ...
      if (p_41184_ instanceof ServerLevel serverlevel) {
         ...
         if (blockpos != null) {
            EyeItemEntity eyeItem = new EyeItemEntity(ModEntityType.CRYPTIC_EYE, p_41184_, p_41185_.getX(), p_41185_.getY(0.5D), p_41185_.getZ());
            eyeItem.setItem(itemstack);
            eyeItem.signalTo(blockpos);
            eyeItem.setSurviveAfterDeath(false);
            eyeItem.setParticle(ModParticleTypes.TOTEM_EFFECT);
            ...
            p_41184_.playSound(null, p_41185_.getX(), p_41185_.getY(), p_41185_.getZ(), SoundEvents.ENDER_EYE_LAUNCH, SoundSource.NEUTRAL, 0.5F, 0.4F / (p_41184_.getRandom().nextFloat() * 0.4F + 0.8F));
