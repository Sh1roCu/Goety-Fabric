...
public class ModBoatItem extends Item {
    ...
    private ModBoat getBoat(Level p_220017_, HitResult p_220018_) {
        return this.hasChest ? new ModChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) : new ModBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z);
    }
}
