...
public class ModItems {
    ...
    public static final Item REPAIR_PUTTY = register("repair_putty", RepairPuttyItem::new);
    ...
    public static final Item PATROL_PLAN = register("patrol_plan", PatrolPlan::new);
    ...
    //Artifacts
    public static final SingleStackItem SOUL_HEALER = register("soul_healer", SoulHealer::new);

    //Focus
    /// Magic
    public static final Item VEXING_FOCUS = register("vexing_focus", () -> new MagicFocus(ModSpells.VEXING));
    public static final Item BITING_FOCUS = register("biting_focus", () -> new MagicFocus(ModSpells.BITING));
    public static final Item FEAST_FOCUS = register("feast_focus", () -> new MagicFocus(ModSpells.FEAST));
    public static final Item TEETH_FOCUS = register("teeth_focus", () -> new MagicFocus(ModSpells.TEETH));
    public static final Item SHREDDING_FOCUS = register("shredding_focus", () -> new MagicFocus(ModSpells.SHREDDING));
    public static final Item ILLUSION_FOCUS = register("illusion_focus", () -> new MagicFocus(ModSpells.ILLUSION));
    public static final Item IGNITE_FOCUS = register("ignite_focus", () -> new MagicFocus(ModSpells.IGNITE));
    public static final Item SOUL_BOLT_FOCUS = register("soul_bolt_focus", () -> new MagicFocus(ModSpells.SOUL_BOLT));
    public static final Item MAGIC_BOLT_FOCUS = register("magic_bolt_focus", () -> new MagicFocus(ModSpells.MAGIC_BOLT));
    public static final Item SWORD_FOCUS = register("sword_focus", () -> new MagicFocus(ModSpells.SWORD));
    public static final Item SOUL_LIGHT_FOCUS = register("soul_light_focus", () -> new MagicFocus(ModSpells.SOUL_LIGHT));
    public static final Item GLOW_LIGHT_FOCUS = register("glow_light_focus", () -> new MagicFocus(ModSpells.GLOW_LIGHT));
    public static final Item ILLUMINATE_FOCUS = register("illuminate_focus", () -> new MagicFocus(ModSpells.ILLUMINATE));
    public static final Item CRAFTING_FOCUS = register("crafting_focus", () -> new MagicFocus(ModSpells.CRAFTING));
    public static final Item IRON_HIDE_FOCUS = register("iron_hide_focus", () -> new MagicFocus(ModSpells.IRON_HIDE));
    public static final Item BULWARK_FOCUS = register("bulwark_focus", () -> new MagicFocus(ModSpells.BULWARK));
    public static final Item SOUL_HEAL_FOCUS = register("soul_heal_focus", () -> new MagicFocus(ModSpells.SOUL_HEAL));
    public static final Item SHOCKWAVE_FOCUS = register("shockwave_focus", () -> new MagicFocus(ModSpells.SHOCKWAVE));
    public static final Item WEAKENING_FOCUS = register("weakening_focus", () -> new MagicFocus(ModSpells.WEAKENING));
    public static final Item ARROW_RAIN_FOCUS = register("arrow_rain_focus", () -> new MagicFocus(ModSpells.ARROW_RAIN));
    public static final Item TELEKINESIS_FOCUS = register("telekinesis_focus", () -> new MagicFocus(ModSpells.TELEKINESIS));
    ...
    public static final Item SONIC_BOOM_FOCUS = register("sonic_boom_focus", () -> new MagicFocus(ModSpells.SONIC_BOOM));
    public static final Item CORRUPTION_FOCUS = register("corruption_focus", () -> new MagicFocus(ModSpells.CORRUPTION));

    /// Necromancy
    public static final Item ROTTING_FOCUS = register("rotting_focus", () -> new MagicFocus(ModSpells.ROTTING));
    public static final Item OSSEOUS_FOCUS = register("osseous_focus", () -> new MagicFocus(ModSpells.OSSEOUS));
    public static final Item GHOST_FIRE_FOCUS = register("ghost_fire_focus", () -> new MagicFocus(ModSpells.GHOST_FIRE));
    public static final Item REAPING_FOCUS = register("reaping_focus", () -> new MagicFocus(ModSpells.REAPING));
    public static final Item SPOOKY_FOCUS = register("spooky_focus", () -> new MagicFocus(ModSpells.SPOOKY));
    public static final Item PHANTASM_FOCUS = register("phantasm_focus", () -> new MagicFocus(ModSpells.PHANTASM));
    public static final Item VANGUARD_FOCUS = register("vanguard_focus", () -> new MagicFocus(ModSpells.VANGUARD));
    public static final Item BLACKGUARD_FOCUS = register("blackguard_focus", () -> new MagicFocus(ModSpells.BLACKGUARD));
    public static final Item LEECHING_FOCUS = register("leeching_focus", () -> new MagicFocus(ModSpells.LEECHING));
    public static final Item KILLING_FOCUS = register("killing_focus", () -> new MagicFocus(ModSpells.KILLING));
    public static final Item SKULL_FOCUS = register("skull_focus", () -> new MagicFocus(ModSpells.SKULL));

    /// Geomancy
    public static final Item BARRICADE_FOCUS = register("barricade_focus", () -> new MagicFocus(ModSpells.BARRICADE));
    public static final Item QUAKING_FOCUS = register("quaking_focus", () -> new MagicFocus(ModSpells.QUAKING));
    public static final Item EARTH_PUNCH_FOCUS = register("earth_punch_focus", () -> new MagicFocus(ModSpells.EARTH_PUNCH));
    public static final Item SMACK_STONE_FOCUS = register("smack_stone_focus", () -> new MagicFocus(ModSpells.SMACK_STONE));
    public static final Item MINISTROUS_FOCUS = register("ministrous_focus", () -> new MagicFocus(ModSpells.MINISTROUS));
    public static final Item PULVERIZE_FOCUS = register("pulverize_focus", () -> new MagicFocus(ModSpells.PULVERIZE));
    public static final Item ROTATION_FOCUS = register("rotation_focus", () -> new MagicFocus(ModSpells.ROTATION));
    public static final Item BURROWING_FOCUS = register("burrowing_focus", () -> new MagicFocus(ModSpells.BURROWING));
    public static final Item SENSING_FOCUS = register("sensing_focus", () -> new MagicFocus(ModSpells.SENSING));
    public static final Item SCATTER_FOCUS = register("scatter_focus", () -> new MagicFocus(ModSpells.SCATTER));
    public static final Item ERUPTION_FOCUS = register("eruption_focus", () -> new MagicFocus(ModSpells.ERUPTION));

    /// Frost
    public static final Item FROST_BREATH_FOCUS = register("frost_breath_focus", () -> new MagicFocus(ModSpells.FROST_BREATH));
    public static final Item ICE_SPIKE_FOCUS = register("ice_spike_focus", () -> new MagicFocus(ModSpells.ICE_SPIKE));
    public static final Item ICE_STORM_FOCUS = register("ice_storm_focus", () -> new MagicFocus(ModSpells.ICE_STORM));
    public static final Item HAIL_FOCUS = register("hail_focus", () -> new MagicFocus(ModSpells.HAIL));
    public static final Item ICEOLOGY_FOCUS = register("iceology_focus", () -> new MagicFocus(ModSpells.ICEOLOGY));
    public static final Item BLIZZARD_FOCUS = register("blizzard_focus", () -> new MagicFocus(ModSpells.BLIZZARD));
    public static final Item CHILLING_FOCUS = register("chilling_focus", () -> new MagicFocus(ModSpells.CHILLING));
    public static final Item FROST_NOVA_FOCUS = register("frost_nova_focus", () -> new MagicFocus(ModSpells.FROST_NOVA));
    public static final Item FROSTBORN_FOCUS = register("frostborn_focus", () -> new MagicFocus(ModSpells.FROSTBORN));

    /// Wild
    public static final Item SWARM_FOCUS = register("swarm_focus", () -> new MagicFocus(ModSpells.SWARM));
    public static final Item POISON_DART_FOCUS = register("poison_dart_focus", () -> new MagicFocus(ModSpells.POISON_DART));
    public static final Item BLOSSOMING_FOCUS = register("blossoming_focus", () -> new MagicFocus(ModSpells.BLOSSOMING));
    public static final Item GRAPPLE_FOCUS = register("grapple_focus", () -> new MagicFocus(ModSpells.GRAPPLE));
    public static final Item HUNTING_FOCUS = register("hunting_focus", () -> new MagicFocus(ModSpells.HUNTING));
    public static final Item MAULING_FOCUS = register("mauling_focus", () -> new MagicFocus(ModSpells.MAULING));
    public static final Item SLIMY_FOCUS = register("slimy_focus", () -> new MagicFocus(ModSpells.SLIMY));
    public static final Item CARRION_FOCUS = register("carrion_focus", () -> new MagicFocus(ModSpells.CARRION));
    public static final Item OVERGROWTH_FOCUS = register("overgrowth_focus", () -> new MagicFocus(ModSpells.OVERGROWTH));
    public static final Item ENTANGLING_FOCUS = register("entangling_focus", () -> new MagicFocus(ModSpells.ENTANGLING));
    public static final Item WHISPERING_FOCUS = register("whispering_focus", () -> new MagicFocus(ModSpells.WHISPERING));
    public static final Item LEAPING_FOCUS = register("leaping_focus", () -> new MagicFocus(ModSpells.LEAPING));

    /// Wind
    public static final Item LAUNCH_FOCUS = register("launch_focus", () -> new MagicFocus(ModSpells.LAUNCH));
    public static final Item FLYING_FOCUS = register("flying_focus", () -> new MagicFocus(ModSpells.FLYING));
    public static final Item CUSHION_FOCUS = register("cushion_focus", () -> new MagicFocus(ModSpells.CUSHION));
    public static final Item WHIRLWIND_FOCUS = register("whirlwind_focus", () -> new MagicFocus(ModSpells.WHIRLWIND));
    public static final Item CYCLONE_FOCUS = register("cyclone_focus", () -> new MagicFocus(ModSpells.CYCLONE));
    public static final Item UPDRAFT_FOCUS = register("updraft_focus", () -> new MagicFocus(ModSpells.UPDRAFT));
    public static final Item WIND_BLAST_FOCUS = register("wind_blast_focus", () -> new MagicFocus(ModSpells.WIND_BLAST));
    public static final Item RAZOR_WIND_FOCUS = register("razor_wind_focus", () -> new MagicFocus(ModSpells.RAZOR_WIND));
    public static final Item TREMBLING_FOCUS = register("trembling_focus", () -> new MagicFocus(ModSpells.TREMBLING));

    /// Storm
    public static final Item CHARGE_FOCUS = register("charge_focus", () -> new MagicFocus(ModSpells.CHARGE));
    public static final Item SHOCKING_FOCUS = register("shocking_focus", () -> new MagicFocus(ModSpells.SHOCKING));
    public static final Item THUNDERBOLT_FOCUS = register("thunderbolt_focus", () -> new MagicFocus(ModSpells.THUNDERBOLT));
    public static final Item ELECTROCUTE_FOCUS = register("electrocute_focus", () -> new MagicFocus(ModSpells.ELECTROCUTE));
    public static final Item SURGING_FOCUS = register("surging_focus", () -> new MagicFocus(ModSpells.SURGING));
    public static final Item SPRIGHTLY_FOCUS = register("sprightly_focus", () -> new MagicFocus(ModSpells.SPRIGHTLY));
    public static final Item MONSOON_FOCUS = register("monsoon_focus", () -> new MagicFocus(ModSpells.MONSOON));
    public static final Item DISCHARGE_FOCUS = register("discharge_focus", () -> new MagicFocus(ModSpells.DISCHARGE));
    public static final Item BOLTING_FOCUS = register("bolting_focus", () -> new MagicFocus(ModSpells.BOLTING));
    public static final Item LIGHTNING_FOCUS = register("lightning_focus", () -> new MagicFocus(ModSpells.LIGHTNING));
    public static final Item THUNDERSTORM_FOCUS = register("thunderstorm_focus", () -> new MagicFocus(ModSpells.THUNDERSTORM));

    /// Abyss
    public static final Item WATER_JET_FOCUS = register("water_jet_focus", () -> new MagicFocus(ModSpells.WATER_JET));
    public static final Item BOUNCY_BUBBLE_FOCUS = register("bouncy_bubble_focus", () -> new MagicFocus(ModSpells.BOUNCY_BUBBLE));
    public static final Item STEAMING_FOCUS = register("steaming_focus", () -> new MagicFocus(ModSpells.STEAMING));
    public static final Item TRIDENT_STORM_FOCUS = register("trident_storm_focus", () -> new MagicFocus(ModSpells.TRIDENT_STORM));
    public static final Item PRISMA_BEAM_FOCUS = register("prisma_beam_focus", () -> new MagicFocus(ModSpells.PRISMA_BEAM));
    public static final Item GUARDIAN_FOCUS = register("guardian_focus", () -> new MagicFocus(ModSpells.GUARDIAN));
    public static final Item BIOMINE_FOCUS = register("biomine_focus", () -> new MagicFocus(ModSpells.BIOMINE));
    public static final Item WATER_WHIP_FOCUS = register("water_whip_focus", () -> new MagicFocus(ModSpells.WATER_WHIP));
    public static final Item TIDAL_FOCUS = register("tidal_focus", () -> new MagicFocus(ModSpells.TIDAL));

    /// Nether
    public static final Item FIRE_BREATH_FOCUS = register("fire_breath_focus", () -> new MagicFocus(ModSpells.FIRE_BREATH));
    public static final Item FIREBALL_FOCUS = register("fireball_focus", () -> new MagicFocus(ModSpells.FIREBALL));
    public static final Item LAVABALL_FOCUS = register("lavaball_focus", () -> new MagicFocus(ModSpells.LAVABALL));
    public static final Item BOMBARDMENT_FOCUS = register("bombardment_focus", () -> new MagicFocus(ModSpells.BOMBARDMENT));
    public static final Item METEOR_SHOWER_FOCUS = register("meteor_shower_focus", () -> new MagicFocus(ModSpells.METEOR_SHOWER));
    public static final Item MAGMA_BOMB_FOCUS = register("magma_bomb_focus", () -> new MagicFocus(ModSpells.MAGMA_BOMB));
    public static final Item FIRE_BLAST_FOCUS = register("fire_blast_focus", () -> new MagicFocus(ModSpells.FIRE_BLAST));
    public static final Item FLAME_STRIKE_FOCUS = register("flame_strike_focus", () -> new MagicFocus(ModSpells.FLAME_STRIKE));
    public static final Item WITHER_SKULL_FOCUS = register("wither_skull_focus", () -> new MagicFocus(ModSpells.WITHER_SKULL));
    public static final Item GHASTLY_FOCUS = register("ghastly_focus", () -> new MagicFocus(ModSpells.GHASTLY));
    public static final Item BLAZING_FOCUS = register("blazing_focus", () -> new MagicFocus(ModSpells.BLAZING));
    public static final Item HOGGING_FOCUS = register("hogging_focus", () -> new MagicFocus(ModSpells.HOGGING));
    ...
    public static final Item ENDER_CHEST_FOCUS = register("ender_chest_focus", () -> new MagicFocus(ModSpells.ENDER_CHEST));
    public static final Item END_WALK_FOCUS = register("end_walk_focus", () -> new MagicFocus(ModSpells.END_WALK));
    public static final Item BLINK_FOCUS = register("blink_focus", () -> new MagicFocus(ModSpells.BLINK));
    public static final Item BANISH_FOCUS = register("banish_focus", () -> new MagicFocus(ModSpells.BANISH));
    public static final Item TUNNEL_FOCUS = register("tunnel_focus", () -> new MagicFocus(ModSpells.TUNNEL));
    public static final Item RUPTURE_FOCUS = register("rupture_focus", () -> new MagicFocus(ModSpells.RUPTURE));
    public static final Item STELLAR_FOCUS = register("stellar_focus", () -> new MagicFocus(ModSpells.STELLAR));
    public static final Item VOID_FLASH_FOCUS = register("void_flash_focus", () -> new MagicFocus(ModSpells.VOID_FLASH));
    public static final Item WATCHING_FOCUS = register("watching_focus", () -> new MagicFocus(ModSpells.WATCHING));
    public static final Item BLASTING_FOCUS = register("blasting_focus", () -> new MagicFocus(ModSpells.BLASTING));
    public static final Item SNARING_FOCUS = register("snaring_focus", () -> new MagicFocus(ModSpells.SNARING));
