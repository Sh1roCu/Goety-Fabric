...
public class GraveGolemSkullItem extends StandingAndWallBlockItem implements ICustomRenderer {

    public GraveGolemSkullItem(Properties p_43250_) {
        super(ModBlocks.GRAVE_GOLEM_SKULL_BLOCK, ModBlocks.WALL_GRAVE_GOLEM_SKULL_BLOCK, p_43250_, Direction.DOWN);
    }
