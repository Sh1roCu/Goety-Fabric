...
public class RedstoneGolemSkullItem extends StandingAndWallBlockItem implements ICustomRenderer {

    public RedstoneGolemSkullItem(Properties p_43250_) {
        super(ModBlocks.REDSTONE_GOLEM_SKULL_BLOCK, ModBlocks.WALL_REDSTONE_GOLEM_SKULL_BLOCK, p_43250_, Direction.DOWN);
    }
