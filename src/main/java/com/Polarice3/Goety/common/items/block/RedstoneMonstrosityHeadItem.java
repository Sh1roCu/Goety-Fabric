...
public class RedstoneMonstrosityHeadItem extends StandingAndWallBlockItem implements ICustomRenderer {

    public RedstoneMonstrosityHeadItem(Properties p_43250_) {
        super(ModBlocks.REDSTONE_MONSTROSITY_HEAD_BLOCK, ModBlocks.WALL_REDSTONE_MONSTROSITY_HEAD_BLOCK, p_43250_, Direction.DOWN);
    }
