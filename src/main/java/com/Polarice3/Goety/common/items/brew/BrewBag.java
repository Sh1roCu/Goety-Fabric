...
public class BrewBag extends TrinketItem {
    public BrewBag() {
            ...
            if (!worldIn.isClientSide) {
                var provider = new ExtendedScreenHandlerFactory() {
                    ...
                    public AbstractContainerMenu createMenu(int i, Inventory inventory, Player player) {
                        return new BrewBagContainer(i, inventory, BrewBagItemHandler.get(itemstack), itemstack);
                    }
...
//    }
    ...
    @Override
    public boolean allowNbtUpdateAnimation(Player player, InteractionHand hand, ItemStack oldStack, ItemStack
            newStack) {
        return super.allowNbtUpdateAnimation(player, hand, oldStack, newStack);
    }

    @Nullable
    public BrewBagItemHandler initCapabilities(@Nonnull ItemStack stack) {
