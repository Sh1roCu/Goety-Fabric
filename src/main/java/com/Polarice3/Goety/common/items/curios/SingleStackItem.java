...
public class SingleStackItem extends TrinketItem implements IEnchantment {
    ...
    public ItemStack getRecipeRemainder(ItemStack itemStack) {
        if (itemStack.is(ModItems.CRONE_HAT)) {
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Enchantment enchantment) {
        if (stack.getItem() == ModItems.SPITEFUL_BELT) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if (stack.getItem() instanceof SingleStackItem) {
            if (stack.is(ModItems.AMETHYST_NECKLACE)) {
            ...
            if (stack.getItem() instanceof WitchHatItem) {
                ...
                if (stack.is(ModItems.CRONE_HAT)) {
            ...
            if (stack.is(ModItems.WIND_CROWN)) {
            ...
            if (stack.is(ModItems.STORM_CROWN)) {
            ...
            if (stack.is(ModItems.WILD_CROWN)) {
            ...
            if (stack.is(ModItems.ABYSS_CROWN)) {
            ...
            if (stack.is(ModItems.VOID_CROWN)) {
            ...
            if (stack.is(ModItems.NETHER_CROWN)) {
            ...
            if (stack.getItem() instanceof MagicRobeItem) {
                if (stack.is(ModItems.GRAND_ROBE)) {
            ...
            if (stack.is(ModItems.RING_OF_WANT)) {
