...
public class EeriePickaxeItem extends PickaxeItem implements IEnchantment {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(ItemStack stack, EquipmentSlot slot) {
        ...
        map.put(ReachEntityAttributes.REACH, new AttributeModifier(UUID.fromString("36907ccf-728b-4ae4-abf1-eaf3283838b5"), "Tool Modifier", 3, AttributeModifier.Operation.ADDITION));
