...
public class ModToolItems {
    ...
    public static class DarkSwordItem extends SwordItem implements IPersist {
        ...
        public DarkSwordItem() {
            super(ModTiers.DARK, 3, -2.4F, ModItems.baseProperties().customDamage(DarkSwordItem::damageItem));
        }
    ...
    public static class DarkShovelItem extends ShovelItem implements IPersist {
        ...
        public DarkShovelItem() {
            super(ModTiers.DARK, 1.5F, -3.0F, ModItems.baseProperties().customDamage(DarkShovelItem::damageItem));
        }
    ...
    public static class DarkPickaxeItem extends PickaxeItem implements IPersist {
        ...
        public DarkPickaxeItem() {
            super(ModTiers.DARK, 1, -2.8F, ModItems.baseProperties().customDamage(DarkPickaxeItem::damageItem));
        }
    ...
    public static class DarkAxeItem extends AxeItem implements IPersist {
        ...
        public DarkAxeItem() {
            super(ModTiers.DARK, 5.0F, -3.0F, ModItems.baseProperties().customDamage(DarkAxeItem::damageItem));
        }
    ...
    public static class DarkHoeItem extends HoeItem implements IPersist {
        ...
        public DarkHoeItem() {
            super(ModTiers.DARK, -3, 0.0F, ModItems.baseProperties().customDamage(DarkHoeItem::damageItem));
        }
