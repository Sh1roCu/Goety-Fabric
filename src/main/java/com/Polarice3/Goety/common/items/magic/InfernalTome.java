...
public class InfernalTome extends Item implements IEnchantment {
    ...
    public void onUseTick(Level worldIn, LivingEntity livingEntityIn, ItemStack stack, int count) {
        ...
        if (stack.getItem() instanceof InfernalTome) {
            ...
            if (CastTime == 1) {
                worldIn.playSound(null, livingEntityIn.getX(), livingEntityIn.getY(), livingEntityIn.getZ(), ModSounds.HERETIC_CHANT, SoundSource.PLAYERS, 2.0F, 0.5F);
            }
            if (!worldIn.isClientSide) {
                ...
                if (count % 10 == 0) {
                    HellChant hellChant = ModEntityType.HELL_CHANT.create(worldIn);
                    if (hellChant != null) {
                        hellChant.setExtraDamage(EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.POTENCY, stack));
                        hellChant.setBurning(EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.BURNING, stack));
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Enchantment enchantment) {
        return enchantment == ModEnchantments.POTENCY
