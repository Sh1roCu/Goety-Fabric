...
public class SoulTakenListener extends SimpleJsonResourceReloadListener implements IdentifiableResourceReloadListener {
    public static Map<ResourceLocation, SoulTakenDataType> ENTITY_LIST = new HashMap<>();
    private static final Gson GSON = (new GsonBuilder()).create();

    public static final ResourceLocation ID = Goety.location("soul_taken");
            ...
            if (!ENTITY_LIST.isEmpty()) {
                for (SoulTakenDataType dataType : ENTITY_LIST.values()) {
                    ...
                    if (dataType.entityType != null) {
                        ...
                        if (!dataType.entityType.equals(BuiltInRegistries.ENTITY_TYPE.getDefaultKey()) && entityType != EntityType.PIG) {
