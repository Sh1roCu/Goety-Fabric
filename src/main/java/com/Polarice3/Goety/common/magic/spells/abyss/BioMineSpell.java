...
public class BioMineSpell extends Spell {
    ...
    public SoundEvent CastingSound() {
        return ModSounds.ABYSS_PREPARE_SPELL;
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            BioMine bioMine = new BioMine(ModEntityType.BIOMINE, worldIn);
            bioMine.setPos(vec3);
            ...
            if (worldIn.addFreshEntity(bioMine)) {
                ...
                worldIn.playSound(null, vec3.x, vec3.y, vec3.z, ModSounds.BIOMINE_SPAWN, SoundSource.PLAYERS, 1.0F, 1.0F);
            }
        }
    }
}
