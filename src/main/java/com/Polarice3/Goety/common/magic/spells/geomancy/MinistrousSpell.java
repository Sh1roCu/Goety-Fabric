    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (!isShifting(caster)) {
            ...
            for (int i1 = 0; i1 < i; ++i1) {
                Summoned summonedentity = new StoneMinistrosity(ModEntityType.STONE_MINISTROSITY, worldIn);
                if (this.GeoPower(caster)) {
                    summonedentity = new RedstoneMinistrosity(ModEntityType.REDSTONE_MINISTROSITY, worldIn);
                }
