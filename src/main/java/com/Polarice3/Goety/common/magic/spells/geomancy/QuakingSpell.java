...
public class QuakingSpell extends Spell {
    ...
    public static void tremor(LivingEntity livingEntity, int distance, double topY, float side, float damage, float airborne) {
        ...
        if (distance % 4 == 0) {
            livingEntity.level.playSound(null, blockPos.above(), ModSounds.WALL_ERUPT, SoundSource.PLAYERS, 1.0F, 0.8F + livingEntity.level.random.nextFloat() * 0.4F);
            livingEntity.level.playSound(null, blockPos.above(), ModSounds.DIRT_DEBRIS, SoundSource.PLAYERS, 1.0F, 0.8F + livingEntity.level.random.nextFloat() * 0.4F);
    ...
    private void tremorSound(LivingEntity livingEntity, float distance, float math) {
        ...
        livingEntity.level.playSound(null, livingEntity.getX() + distance * vecX + f * math, livingEntity.getY(), livingEntity.getZ() + distance * vecZ + f1 * math, ModSounds.WALL_ERUPT, SoundSource.PLAYERS, 1.0F, 0.8F + livingEntity.level.random.nextFloat() * 0.4F);
        livingEntity.level.playSound(null, livingEntity.getX() + distance * vecX + f * math, livingEntity.getY(), livingEntity.getZ() + distance * vecZ + f1 * math, ModSounds.DIRT_DEBRIS, SoundSource.PLAYERS, 1.0F, 0.8F + livingEntity.level.random.nextFloat() * 0.4F);
