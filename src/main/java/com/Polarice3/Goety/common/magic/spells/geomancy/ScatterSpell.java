        ...
        if (rightStaff(stack)) {
            for (int i = 0; i < 5; ++i) {
                ...
                if (worldIn instanceof ServerLevel serverLevel) {
                    serverLevel.sendParticles(ModParticleTypes.BIG_ELECTRIC, caster.getRandomX(0.5D), caster.getEyeY() - serverLevel.random.nextInt(5), caster.getRandomZ(0.5D), 0, d0, d1, d2, 0.5F);
                }
            }
        }
    }
