    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (!isShifting(caster)) {
            ...
            for (int i1 = 0; i1 < l; ++i1) {
                PhantomServant phantom = ModEntityType.PHANTOM_SERVANT.create(worldIn);
                if (phantom != null) {
                    ...
                    spawngroupdata = phantom.finalizeSpawn(worldIn, difficultyinstance, MobSpawnType.MOB_SUMMONED, spawngroupdata, null);
