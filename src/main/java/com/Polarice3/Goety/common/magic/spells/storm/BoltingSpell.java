...
public class BoltingSpell extends Spell {
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        this.playSound(worldIn, caster, ModSounds.HEAVY_WOOSH, 3.0F, 1.0F);
        this.playSound(worldIn, caster, ModSounds.REDSTONE_EXPLODE, 3.0F, 1.0F);
    }
    ...
    public static class BoltingDashTask implements EventTask {
        ...
        public void startTask() {
            if (this.level.getEntity(this.owner) instanceof LivingEntity living) {
                ...
                this.level.sendParticles(ModParticleTypes.ELECTRIC_EXPLODE, living.getX(), living.getY() + 0.5F, living.getZ(), 0, colorUtil.red(), colorUtil.green(), colorUtil.blue(), 1.0F);
            }
        }
        ...
        public void tickTask() {
            ...
            if (this.level.getEntity(this.owner) instanceof LivingEntity living) {
                ...
                for (int i = 0; i < 2; ++i) {
                    ...
                    this.level.sendParticles(ModParticleTypes.BIG_ELECTRIC, living.getRandomX(1.0D), living.getRandomY(), living.getRandomZ(1.0D), 0, d0, d1, d2, 0.5F);
                }
                ServerParticleUtil.addParticlesAroundMiddleSelf(this.level, ModParticleTypes.ELECTRIC, living);
