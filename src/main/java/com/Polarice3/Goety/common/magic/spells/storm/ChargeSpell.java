        ...
        if (this.rightStaff(staff)) {
            ...
            if (!target.hasEffect(GoetyEffects.CHARGED)) {
                ...
                if (instance != null) {
                    ...
                    EffectsUtil.amplifyEffect(target, GoetyEffects.CHARGED, MathHelper.secondsToTicks(30), 3, false, false);
                }
            }
        }
    }
            ...
            if (!entities.isEmpty()) {
                ...
                if (entity instanceof LivingEntity target) {
                    ...
                    if (prevTarget != target) {
                        ...
                        ModNetwork.sendToALL(serverLevel.getServer(), SLightningPacket.ID, SLightningPacket.encode(vec3, vec31, 5));
                    }
