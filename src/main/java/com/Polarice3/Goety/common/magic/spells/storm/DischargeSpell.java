...
public class DischargeSpell extends Spell {
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        for (int i = 0; i < 16; ++i) {
            ...
            ModNetwork.sendToALL(worldIn.getServer(), SLightningPacket.ID, SLightningPacket.encode(vec3, vec31, colorUtil, 12));
        }
        ...
        this.playSound(worldIn, caster, ModSounds.REDSTONE_EXPLODE, 2.0F, 1.0F);
    }
}
