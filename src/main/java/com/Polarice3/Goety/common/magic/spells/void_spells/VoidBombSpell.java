...
public class VoidBombSpell extends Spell {
    ...
    public SoundEvent CastingSound() {
        return ModSounds.VOID_PREPARE_SPELL;
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        this.playSound(worldIn, caster, ModSounds.HEAVY_WOOSH, 3.0F, caster.getVoicePitch());
        this.playSound(worldIn, caster, ModSounds.TELEPORT_ORB_THROW, 3.0F, caster.getVoicePitch() - 0.5F);
