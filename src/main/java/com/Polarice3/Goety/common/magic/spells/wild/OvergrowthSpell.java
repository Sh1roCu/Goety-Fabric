    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (target != null) {
            if (this.isShifting(caster)) {
                ...
                EntityType<? extends AbstractMonolith> entityType = ModEntityType.POISON_QUILL_VINE;
                ...
                EntityType<? extends AbstractMonolith> entityType = ModEntityType.QUICK_GROWING_VINE;
                if (random == 0) {
