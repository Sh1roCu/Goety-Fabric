...
public class SwarmSpell extends BreathingSpell {
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        this.playSound(worldIn, caster, ModSounds.INSECT_SWARM, worldIn.random.nextFloat() * 0.5F, worldIn.random.nextFloat() * 0.5F);
    }
    ...
    public void showWandBreath(LivingEntity entityLiving, ItemStack staff, SpellStat spellStat) {
        ...
        this.breathAttack(ModParticleTypes.FLY, entityLiving, true, 0.3F + ((double) range / 10), 5);
    }
}
