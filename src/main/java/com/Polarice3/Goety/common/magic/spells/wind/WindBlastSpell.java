    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        for (int i = 1; i < range; ++i) {
            ...
            if (typeStaff(staff, SpellType.FROST)) {
                worldIn.sendParticles(ModParticleTypes.FROST, vector3d2.x, vector3d2.y, vector3d2.z, 1, 0.0D, 0.0D, 0.0D, 0.0D);
            }
            if (typeStaff(staff, SpellType.WILD)) {
                worldIn.sendParticles(ModParticleTypes.FLY, vector3d2.x, vector3d2.y, vector3d2.z, 1, 0.0D, 0.0D, 0.0D, 0.0D);
            }
        ...
        this.playSound(worldIn, caster, ModSounds.WIND_BLAST, 0.3F, 1.3F);
    }
}
