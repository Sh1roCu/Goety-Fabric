...
public class SLootingExplosionPacket {
    ...
    public static final ResourceLocation ID = Goety.location("s2c_looting_explosion");
    ...
    public static void consume(Minecraft client, ClientPacketListener handler, FriendlyByteBuf buf, PacketSender responseSender) {
        ...
        client.execute(() -> {
            ...
            if (player != null) {
                LootingExplosion explosion = new LootingExplosion(player.level, null, x, y, z, power, false, Explosion.BlockInteraction.KEEP, LootingExplosion.Mode.REGULAR);
