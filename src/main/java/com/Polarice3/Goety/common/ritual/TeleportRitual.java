    ...
    public void finish(Level world, BlockPos blockPos, DarkAltarBlockEntity tileEntity,
        ...
        if (globalPos != null) {
            ...
            if (world instanceof ServerLevel serverLevel) {
                ...
                ModNetwork.sendToALL(serverLevel.getServer(), SPlayWorldSoundPacket.ID, SPlayWorldSoundPacket.encode(BlockPos.containing(castingPlayer.xo, castingPlayer.yo, castingPlayer.zo), SoundEvents.ENDERMAN_TELEPORT, 1.0F, 1.0F));
                ModNetwork.sendToALL(serverLevel.getServer(), SPlayWorldSoundPacket.ID, SPlayWorldSoundPacket.encode(blockPos1, SoundEvents.ENDERMAN_TELEPORT, 1.0F, 1.0F));
            }
