...
public class ConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> p_256171_) {
        ...
        FeatureUtils.register(p_256171_, MEGA_CHORUS_TREE, ModFeatures.CHORUS_TREE, createMegaChorus().build());
        FeatureUtils.register(p_256171_, MEGA_CHORUS_VOID_TREE, ModFeatures.CHORUS_VOID_TREE, createMegaChorus().build());
        FeatureUtils.register(p_256171_, MEGA_CHORUS_BLOSSOM_TREE, ModFeatures.CHORUS_TREE, createMegaChorusBlossom().build());
        FeatureUtils.register(p_256171_, MEGA_CHORUS_BLOSSOM_VOID_TREE, ModFeatures.CHORUS_VOID_TREE, createMegaChorusBlossom().build());
    }

    private static TreeConfiguration.TreeConfigurationBuilder createHaunted() {
        return (new TreeConfiguration
                .TreeConfigurationBuilder(BlockStateProvider.simple(ModBlocks.HAUNTED_LOG),
    ...
    private static TreeConfiguration.TreeConfigurationBuilder createRotten() {
        return createStraightBlobTree(ModBlocks.ROTTEN_LOG, ModBlocks.ROTTEN_LEAVES, 4, 8, 0, 2);
    }

    private static TreeConfiguration.TreeConfigurationBuilder createFancyRotten() {
        return (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(ModBlocks.ROTTEN_LOG), new FancyTrunkPlacer(3, 11, 0), BlockStateProvider.simple(ModBlocks.ROTTEN_LEAVES), new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(4), 4), new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4)))).ignoreVines();
    }

    private static TreeConfiguration.TreeConfigurationBuilder createWindswept() {
        return (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(ModBlocks.WINDSWEPT_LOG), new ForkingTrunkPlacer(5, 2, 2), BlockStateProvider.simple(ModBlocks.WINDSWEPT_LEAVES), new AcaciaFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 2))).ignoreVines();
    }

    private static TreeConfiguration.TreeConfigurationBuilder createWindswept2() {
        return createStraightBlobTree(ModBlocks.WINDSWEPT_LOG, ModBlocks.WINDSWEPT_LEAVES, 4, 8, 0, 2);
    }

    private static TreeConfiguration.TreeConfigurationBuilder createChorus() {
        return new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(ModBlocks.CHORUS_LOG), new ChorusTrunkPlacer(7, 1, 0, new WeightedListInt(SimpleWeightedRandomList.<IntProvider>builder().add(ConstantInt.of(1), 1).add(ConstantInt.of(2), 1).add(ConstantInt.of(3), 1).build()), UniformInt.of(2, 4), UniformInt.of(-4, -3), UniformInt.of(-1, 0)), BlockStateProvider.simple(ModBlocks.CHORUS_LEAVES), new CherryFoliagePlacer(ConstantInt.of(4), ConstantInt.of(0), ConstantInt.of(5), 0.25F, 0.5F, 0.16666667F, 0.33333334F), new TwoLayersFeatureSize(1, 0, 2)).ignoreVines();
    }

    private static TreeConfiguration.TreeConfigurationBuilder createChorusBlossom() {
        return new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(ModBlocks.CHORUS_LOG), new ChorusTrunkPlacer(7, 1, 0, new WeightedListInt(SimpleWeightedRandomList.<IntProvider>builder().add(ConstantInt.of(1), 1).add(ConstantInt.of(2), 1).add(ConstantInt.of(3), 1).build()), UniformInt.of(2, 4), UniformInt.of(-4, -3), UniformInt.of(-1, 0)), BlockStateProvider.simple(ModBlocks.CHORUS_BLOSSOM_LEAVES), new CherryFoliagePlacer(ConstantInt.of(4), ConstantInt.of(0), ConstantInt.of(5), 0.25F, 0.5F, 0.16666667F, 0.33333334F), new TwoLayersFeatureSize(1, 0, 2)).ignoreVines();
    }
    ...
    private static ModTreeFeatureConfig.Builder createMegaChorus() {
        return new ModTreeFeatureConfig.Builder(
                BlockStateProvider.simple(ModBlocks.CHORUS_WOOD),
                BlockStateProvider.simple(ModBlocks.CHORUS_LEAVES),
                BlockStateProvider.simple(ModBlocks.CHORUS_WOOD),
                BlockStateProvider.simple(Blocks.AIR)
        );
    }
    ...
    private static ModTreeFeatureConfig.Builder createMegaChorusBlossom() {
        return new ModTreeFeatureConfig.Builder(
                BlockStateProvider.simple(ModBlocks.CHORUS_WOOD),
                BlockStateProvider.simple(ModBlocks.CHORUS_BLOSSOM_LEAVES),
                BlockStateProvider.simple(ModBlocks.CHORUS_WOOD),
                BlockStateProvider.simple(Blocks.AIR)
        );
    }
