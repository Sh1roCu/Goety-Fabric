...
public class ModRandomSpread extends RandomSpreadStructurePlacement {
    ...
    public ModRandomSpread(Vec3i locationOffset, FrequencyReductionMethod frequencyReductionMethod, float frequency, int salt, Optional<ExclusionZone> exclusionZone, Optional<SuperExclusionZone> superExclusionZone, int spacing, int separation, RandomSpreadType spreadType, Optional<Integer> minDistanceFromWorldOrigin) {
    ...
    public StructurePlacementType<?> type() {
        return ModPlacementType.MOD_RANDOM_SPREAD;
    }
