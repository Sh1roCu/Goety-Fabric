...
public class IronAttributes {
    ...
    private static Attribute getAttribute(String id) {
        return BuiltInRegistries.ATTRIBUTE.get(new ResourceLocation("irons_spellbooks", id));
    }

    private static Attribute getResistanceAttribute(String id) {
        return BuiltInRegistries.ATTRIBUTE.get(new ResourceLocation("irons_spellbooks", id + "_magic_resist"));
    }

    private static Attribute getPowerAttribute(String id) {
        return BuiltInRegistries.ATTRIBUTE.get(new ResourceLocation("irons_spellbooks", id + "_spell_power"));
    }
