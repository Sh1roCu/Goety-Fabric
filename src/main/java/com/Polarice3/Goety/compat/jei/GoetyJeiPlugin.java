...
public class GoetyJeiPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.CURSED_INFUSER), JeiRecipeTypes.CURSED_INFUSER);
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.GRIM_INFUSER), JeiRecipeTypes.CURSED_INFUSER);
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.DARK_ALTAR), JeiRecipeTypes.RITUAL);
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.PEDESTAL), JeiRecipeTypes.RITUAL);
        for (IRitualType ritualType : RitualType.getAllRitualType()) {
            registration.addRecipeCatalyst(ritualType.getJeiIcon(), JeiRecipeTypes.getRitual(ritualType.getName()));
        }
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.NECRO_BRAZIER), JeiRecipeTypes.BRAZIER);
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.BREWING_CAULDRON), JeiRecipeTypes.CAULDRON);
        registration.addRecipeCatalyst(new ItemStack(ModItems.PULVERIZE_FOCUS), JeiRecipeTypes.PULVERIZE);
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.SOUL_ABSORBER), JeiRecipeTypes.SOUL_ABSORBER);
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.BREWING_CAULDRON), JeiRecipeTypes.BREWING);
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<CursedInfuserRecipes> cursedRecipes = recipeManager.getAllRecipesFor(ModRecipeSerializer.CURSED_INFUSER);
        registration.addRecipes(JeiRecipeTypes.CURSED_INFUSER, cursedRecipes);
        List<RitualRecipe> ritualRecipes = recipeManager.getAllRecipesFor(ModRecipeSerializer.RITUAL_TYPE);
        ...
        List<BrazierRecipe> brazierRecipes = recipeManager.getAllRecipesFor(ModRecipeSerializer.BRAZIER_TYPE);
        registration.addRecipes(JeiRecipeTypes.BRAZIER, brazierRecipes);
        List<CauldronRecipe> cauldronRecipes = recipeManager.getAllRecipesFor(ModRecipeSerializer.CAULDRON_TYPE);
        registration.addRecipes(JeiRecipeTypes.CAULDRON, cauldronRecipes);
        List<PulverizeRecipe> pulverizeRecipes = recipeManager.getAllRecipesFor(ModRecipeSerializer.PULVERIZE_TYPE);
        registration.addRecipes(JeiRecipeTypes.PULVERIZE, pulverizeRecipes);
        List<SoulAbsorberRecipes> soulAbsorberRecipes = recipeManager.getAllRecipesFor(ModRecipeSerializer.SOUL_ABSORBER);
    ...
    public List<RitualRecipe> ritualTypeRecipe(RecipeManager recipeManager, String type) {
        return recipeManager.getAllRecipesFor(ModRecipeSerializer.RITUAL_TYPE).stream().filter(ritualRecipe -> ritualRecipe.getCraftType().contains(type)).toList();
    }
