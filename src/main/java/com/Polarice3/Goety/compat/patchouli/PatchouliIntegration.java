...
public class PatchouliIntegration implements ICompatable {
    ...
    public static final Supplier<IMultiblock> WHISPERER = Suppliers.memoize(() -> {
        IStateMatcher leaves = PatchouliAPI.get().predicateMatcher(ModBlocks.OVERGROWN_ROOTS,
                state -> state.is(ModBlocks.OVERGROWN_ROOTS));
        IStateMatcher moss = PatchouliAPI.get().predicateMatcher(Blocks.MOSS_BLOCK,
                state -> state.is(Blocks.MOSS_BLOCK));
        IStateMatcher blossom = PatchouliAPI.get().predicateMatcher(ModBlocks.CORPSE_BLOSSOM,
                state -> state.is(ModBlocks.CORPSE_BLOSSOM));
    ...
    public static final Supplier<IMultiblock> LEAPLEAF = Suppliers.memoize(() -> {
        IStateMatcher roots = PatchouliAPI.get().predicateMatcher(ModBlocks.OVERGROWN_ROOTS,
                state -> state.is(ModBlocks.OVERGROWN_ROOTS));
    ...
    public static final Supplier<IMultiblock> SQUALL_GOLEM = Suppliers.memoize(() -> {
        IStateMatcher highrockMold = PatchouliAPI.get().predicateMatcher(ModBlocks.POLISHED_HIGHROCK_BLOCK,
                state -> state.is(ModBlocks.POLISHED_HIGHROCK_BLOCK));
        IStateMatcher grateMold = PatchouliAPI.get().predicateMatcher(ModBlocks.RUSTY_IRON_GRATE,
                state -> state.is(ModBlocks.RUSTY_IRON_GRATE));
        IStateMatcher bricks = PatchouliAPI.get().predicateMatcher(Blocks.STONE_BRICKS,
                state -> state.is(Blocks.STONE_BRICKS));
        IStateMatcher gold = PatchouliAPI.get().predicateMatcher(ModBlocks.INDENTED_GOLD_BLOCK,
                state -> state.is(ModTags.Blocks.INDENTED_GOLD_BLOCKS));
        IStateMatcher jade = PatchouliAPI.get().predicateMatcher(ModBlocks.JADE_BLOCK,
                state -> state.is(ModBlocks.JADE_BLOCK));
        return PatchouliAPI.get().makeMultiblock(
                new String[][]{
                        {
                                "_________",
    ...
    public static final Supplier<IMultiblock> REDSTONE_GOLEM = Suppliers.memoize(() -> {
        IStateMatcher diamondMold = PatchouliAPI.get().predicateMatcher(ModBlocks.DIAMOND_MOLD_BLOCK,
                state -> state.is(ModBlocks.DIAMOND_MOLD_BLOCK));
        IStateMatcher redstoneCore = PatchouliAPI.get().predicateMatcher(Blocks.REDSTONE_BLOCK,
                state -> state.is(Blocks.REDSTONE_BLOCK/*Tags.Blocks.STORAGE_BLOCKS_REDSTONE*/));
    ...
    public static final Supplier<IMultiblock> REDSTONE_GOLEM_REVIVE = Suppliers.memoize(() -> {
        IStateMatcher diamond = PatchouliAPI.get().predicateMatcher(ModBlocks.DIAMOND_MOLD_BLOCK,
                state -> state.is(ModBlocks.DIAMOND_MOLD_BLOCK));
        IStateMatcher redstoneCore = PatchouliAPI.get().predicateMatcher(Blocks.REDSTONE_BLOCK,
                state -> state.is(Blocks.REDSTONE_BLOCK/*Tags.Blocks.STORAGE_BLOCKS_REDSTONE*/));
        return PatchouliAPI.get().makeMultiblock(
                ...
                'H', ModBlocks.REDSTONE_GOLEM_SKULL_BLOCK,
                'R', redstoneCore,
                '0', diamond
        );
    });
    ...
    public static final Supplier<IMultiblock> GRAVE_GOLEM = Suppliers.memoize(() -> {
        IStateMatcher stoneMold = PatchouliAPI.get().predicateMatcher(Blocks.STONE_BRICKS,
                state -> state.getBlock().getDescriptionId().contains("bricks") && !(state.getBlock() instanceof SlabBlock) && !(state.getBlock() instanceof StairBlock) && !(state.getBlock() instanceof WallBlock));
        IStateMatcher darkMetalMold = PatchouliAPI.get().predicateMatcher(ModBlocks.DARK_ALLOY_BLOCK,
                state -> state.is(ModBlocks.DARK_ALLOY_BLOCK));
        IStateMatcher coarseDirt = PatchouliAPI.get().predicateMatcher(ModBlocks.GRAVE_SOIL,
                state -> state.is(ModBlocks.GRAVE_SOIL));
        IStateMatcher skullPiles = PatchouliAPI.get().predicateMatcher(ModBlocks.SKULL_PILE,
                state -> state.is(ModBlocks.SKULL_PILE));
        IStateMatcher shadeBody = PatchouliAPI.get().predicateMatcher(ModBlocks.SHADE_STONE_BLOCK,
    ...
    public static final Supplier<IMultiblock> REDSTONE_MONSTROSITY = Suppliers.memoize(() -> {
        ...
        IStateMatcher redstone = PatchouliAPI.get().predicateMatcher(Blocks.REDSTONE_BLOCK,
                state -> state.is(Blocks.REDSTONE_BLOCK/*Tags.Blocks.STORAGE_BLOCKS_REDSTONE*/));
        IStateMatcher redstoneCore = PatchouliAPI.get().predicateMatcher(ModBlocks.REINFORCED_REDSTONE_BLOCK,
                state -> state.is(ModBlocks.REINFORCED_REDSTONE_BLOCK));
        IStateMatcher stoneMold = PatchouliAPI.get().predicateMatcher(Blocks.STONE_BRICKS,
                state -> state.getBlock().getDescriptionId().contains("bricks") && !(state.getBlock() instanceof SlabBlock) && !(state.getBlock() instanceof StairBlock) && !(state.getBlock() instanceof WallBlock));
        return PatchouliAPI.get().makeMultiblock(
                new String[][]{
    ...
    public static final Supplier<IMultiblock> REDSTONE_MONSTROSITY_REVIVE = Suppliers.memoize(() -> {
        ...
        IStateMatcher diamondMold = PatchouliAPI.get().predicateMatcher(ModBlocks.DIAMOND_MOLD_BLOCK,
                state -> state.is(ModBlocks.DIAMOND_MOLD_BLOCK));
        IStateMatcher reinforced = PatchouliAPI.get().predicateMatcher(ModBlocks.REINFORCED_REDSTONE_BLOCK,
                state -> state.is(ModBlocks.REINFORCED_REDSTONE_BLOCK));
        return PatchouliAPI.get().makeMultiblock(
                new String[][]{
                        {
                ...
                'H', ModBlocks.REDSTONE_MONSTROSITY_HEAD_BLOCK,
                '#', redstoneBlocks,
                'R', reinforced,
                'D', diamondMold,
                '0', diamondMold
    ...
    public static final Supplier<IMultiblock> SO_EXAMPLE = Suppliers.memoize(() -> {
        IStateMatcher obelisk = PatchouliAPI.get().predicateMatcher(ModBlocks.SHRIEKING_OBELISK,
                state -> state.is(ModBlocks.SHRIEKING_OBELISK));
        IStateMatcher cage = PatchouliAPI.get().predicateMatcher(ModBlocks.CURSED_CAGE_BLOCK,
                state -> state.is(ModBlocks.CURSED_CAGE_BLOCK));
        IStateMatcher filler = PatchouliAPI.get().predicateMatcher(Blocks.COBBLESTONE,
                state -> state.is(Blocks.COBBLESTONE));
        IStateMatcher skull = PatchouliAPI.get().predicateMatcher(ModBlocks.TALL_SKULL_BLOCK,
                state -> state.is(ModBlocks.TALL_SKULL_BLOCK));
