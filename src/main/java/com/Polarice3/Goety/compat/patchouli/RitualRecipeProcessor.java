...
public class RitualRecipeProcessor implements IComponentProcessor {
    ...
    public void setup(Level level, IVariableProvider iVariableProvider) {
        ...
        this.pedestal = new ItemStack(ModItems.PEDESTAL_DUMMY);
    }
    ...
    public IVariable process(Level level, String key) {
        ...
        if (key.equals("output")) {
            ...
            } else if (this.recipe.getResultItem(level.registryAccess()).getItem() != ModItems.JEI_DUMMY_NONE) {
                return IVariable.from(this.recipe.getResultItem(level.registryAccess()));
            } else {
                return IVariable.from(new ItemStack(ModItems.JEI_DUMMY_NONE));
            }
        }
