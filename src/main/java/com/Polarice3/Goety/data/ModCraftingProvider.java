...
public class ModCraftingProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.OMINOUS_STONE_PILLAR_BLOCK)
                .pattern("#")
                .pattern("#")
                .define('#', ModBlocks.OMINOUS_STONE_TILE_SLAB)
                .unlockedBy("has_item", has(ModBlocks.OMINOUS_STONE_TILE_SLAB))
                .save(consumer, loc("ominous/ominous_stone_pillar"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_OMINOUS_STONE_BLOCK)
                .pattern("#")
                .pattern("#")
                .define('#', ModBlocks.OMINOUS_STONE_SLAB)
                .unlockedBy("has_item", has(ModBlocks.OMINOUS_STONE_SLAB))
                .save(consumer, loc("ominous/chiseled_ominous_stone"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_POLISHED_OMINOUS_STONE_BLOCK)
                .pattern("#")
                .pattern("#")
                .define('#', ModBlocks.POLISHED_OMINOUS_STONE_SLAB)
                .unlockedBy("has_item", has(ModBlocks.POLISHED_OMINOUS_STONE_SLAB))
                .save(consumer, loc("ominous/chiseled_polished_ominous_stone"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_OMINOUS_STONE_BRICKS_BLOCK)
                .pattern("#")
                .pattern("#")
                .define('#', ModBlocks.OMINOUS_STONE_BRICK_SLAB)
                .unlockedBy("has_item", has(ModBlocks.OMINOUS_STONE_BRICK_SLAB))
        ...
        smelting(consumer, "ominous/ominous_stone", ModBlocks.COBBLED_OMINOUS_STONE_BLOCK, ModBlocks.OMINOUS_STONE_BLOCK);
        smelting(consumer, "ominous/cracked_polished_ominous_stone", ModBlocks.POLISHED_OMINOUS_STONE_BLOCK, ModBlocks.CRACKED_POLISHED_OMINOUS_STONE_BLOCK);
        smelting(consumer, "ominous/cracked_ominous_stone_bricks", ModBlocks.OMINOUS_STONE_BRICKS_BLOCK, ModBlocks.CRACKED_OMINOUS_STONE_BRICKS_BLOCK);
