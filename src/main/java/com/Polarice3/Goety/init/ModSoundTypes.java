...
public class ModSoundTypes {
    public static final SoundType URN = new SoundType(1.0F, 1.0F,
            ModSounds.URN_BREAK,
    ...
    public static final SoundType MOD_METAL = new SoundType(1.0F, 1.0F,
    ...
    public static final SoundType CHORUS_GRASS = new SoundType(1.0F, 1.0F,
