...
public class ModTags {
    ...
    public static class FLuids {
        ...
        public static final TagKey<Fluid> VOID = TagRegistration.FLUID_TAG_REGISTRATION.registerCommon("void");
    }
    ...
    public static class Blocks {
        ...
        private static TagKey<Block> tag(String name) {
            return TagKey.create(Registries.BLOCK, Goety.location(name));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> tag(String name) {
            return TagKey.create(Registries.ITEM, Goety.location(name));
        }
    }
