...
public class ModTrimMaterials {
    ...
    public static void bootstrap(BootstapContext<TrimMaterial> context) {
        register(context, CURSED, ModItems.CURSED_METAL_INGOT, Style.EMPTY.withColor(0x1c303a), 0.9F);
        register(context, DARK, ModItems.DARK_ALLOY_INGOT, Style.EMPTY.withColor(0x1f1f1f), 0.3F);
        register(context, ECTO, ModItems.ECTOPLASM, Style.EMPTY.withColor(0x00c2d6), 0.8F);
        register(context, JADE, ModItems.JADE, Style.EMPTY.withColor(0x00fa68), 0.7F);
    }
